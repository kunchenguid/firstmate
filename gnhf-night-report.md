# Attempt-ledger typing night report
...
## Branch diffstat versus 374043d

```text
 bin/fm-model-telemetry.sh         |  51 ++++++----
 docs/documentation-audiences.json |   4 +
 gnhf-score.txt                    | 110 ++++++++++++++++++++++
 tests/fm-model-telemetry.test.sh  | 193 ++++++++++++++++++++++++++++++++++++++
 4 files changed, 341 insertions(+), 17 deletions(-)
```

Iteration 8 adds this report, the rejected patch, and the score/inventory update.
No spawn or teardown control flow was edited.
No caller telemetry payload construction was edited.
