...
> **2026-08-02 20:03** · branch: `detached`

**Commits (today)**
- 19ea13a fix: restore CLAUDE.md symlink to AGENTS.md, drop session block
- 70d125f no-mistakes(document): docs: presentation contract current in fm-brief owner header
