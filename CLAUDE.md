...
> **2026-08-02 18:35** · branch: `detached`
...
- 621299a fix: preserve Calm boat continuity across working periods (#1356)
- 96542a4 feat(bin): replace busy heuristics with semantic lifecycle state (#1327)
