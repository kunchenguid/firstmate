...
> **2026-08-02 18:43** · branch: `detached`

**Commits (today)**
- 44c538e no-mistakes(review): commit CLAUDE.md symlink at tree level, immune to hook rewrite
- f99f606 no-mistakes(review): restore CLAUDE.md symlink via index, bypassing session hook
- 1d5db8e no-mistakes(review): restore CLAUDE.md symlink via index, bypassing session hook
- e9283b1 no-mistakes(review): restore CLAUDE.md symlink, drop committed session-progress block
- 026fb3c fix: restore CLAUDE.md symlink to AGENTS.md
- 2766b4f no-mistakes(document): document shared presentation contract in fm-brief header
- b3deed8 fix(brief): add shared ASCII presentation contract
- cd73e75 fix(bin): retire terminal process events and surface queued wakes (#1500)
- 8c21b10 feat(bin): add durable process-event supervision (#1483)

**Recent Commits (for context)**
- 1e24757 fix(bin): parse punctuated secondmate registry entries safely (#1452)
- 68641a3 fix(bin): preserve full task contract in no-mistakes intent (#1447)
- a805766 fix: prioritize completion runway in quota-aware dispatch (#1431)
- 66b0f77 fix(herdr): prevent focus flashes during projected workspace cleanup (#1229)
- 000c1db fix: bind backend overrides to exact-task authority (#1413)
- 9fdef64 docs: define validation supersession sequence (#1407)
