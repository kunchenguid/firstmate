...
> **2026-08-03 15:03** · branch: `detached`

**Commits (today)**
- ec0082e no-mistakes(test): add specgraph siblings to backend conformance fixture list
- c3a9a05 no-mistakes(review): restore CLAUDE.md symlink in index with skip-worktree guard
- 729cbb0 no-mistakes(review): restore CLAUDE.md symlink to AGENTS.md
- c02bf31 no-mistakes(review): reclaim stale capture locks and reseed sequence from snapshots
- b5d55ac feat: capture SpecGraph snapshots
