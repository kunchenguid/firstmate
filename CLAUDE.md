...
> **2026-08-02 18:51** · branch: `detached`

**Commits (today)**
- 1738e7c fix: restore CLAUDE.md symlink after pipeline hooks
- f987554 no-mistakes(document): docs: presentation contract already owned by fm-brief header
