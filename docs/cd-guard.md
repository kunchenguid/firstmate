...
| Codex | `.codex/hooks.json` PreToolUse hook that execs the script directly and forwards the payload; the script owns its own root anchoring | Blocks on exit 2 and displays stderr. |
