...
| Codex | `.codex/hooks.json` PreToolUse hook that resolves the containing Git root, verifies the hook-loaded firstmate root, and forwards the payload | Blocks on exit 2 and displays stderr. |
