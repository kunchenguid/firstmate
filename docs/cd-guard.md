...
`bin/fm-cd-pretool-check.sh` supports the tracked harness entry shapes:
...
Every block and allow case runs through Claude-shaped stdin, OpenCode-shaped CLI, and Pi-shaped CLI entry forms.
