...
All three harnesses ran against git-initialized scratch projects and isolated `FM_HOME` state.
...
Observed result: `ok - Pi 0.80.10 live E2E used the shared openai-codex provider auth, auto-started one successor before turn end, and cleaned up`.
