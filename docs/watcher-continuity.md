...
`tests/fm-watcher-lock.test.sh` also covers `bin/fm-wake-lib.sh`'s Git Bash/MSYS directory-lock publication, including simultaneous single-winner acquisition, clean losing contenders, release, and abandoned-owner recovery.
