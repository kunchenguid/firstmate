...
Once those gates pass, a recovery-claim failure authorizes and publishes its immutable record and episode marker while holding that lease, requiring either the same authenticated owner or the exact unchanged stale owner observed before recovery.
