...
It pins the same two halves for the watcher's own stale-lock reclaim, which reaches recovery without any arm-side publication: that reclaim stays live and silent over an empty fleet and still resurfaces a real open decision.
