...
That translation is decided ahead of the attended-alarm suppression and clears the episode's markers and block budget, so a stale alarm left by a finished episode can never swallow a real wake.
