...
Cursor's unattended-launch policy, including the envelope-only exemption for this remote route, is owned by [`configuration.md`](configuration.md#harness-support).
