...
Its `--restart` mode is a compatibility spelling for non-destructive re-arm; [`watcher-continuity.md`](watcher-continuity.md#arm-layer-cycle-contract) owns live-holder preservation and stale-lock classification.
