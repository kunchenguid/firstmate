...
A durable `captain-held` endpoint uses that bounded cadence only after the backend confidently reports its agent dead, while live or inconclusive held liveness still surfaces once.
