...
Pi and OpenCode own the lock-verified successor-before-delivery continuity contract detailed in [watcher-continuity.md](watcher-continuity.md), including Pi's final actionability revalidation.
