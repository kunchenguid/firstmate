...
An Azure DevOps URL is followed by the merge watch but never merged here, and is refused before any side effect (see [docs/azure-devops-merge-watch.md](azure-devops-merge-watch.md)).
