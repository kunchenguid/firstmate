...
New-spawn resolution and recorded-endpoint interpretation remain separate mechanisms; [`configuration.md`](configuration.md#runtime-backend-configbackend--fm_backend) owns the default, auto-detection notices, and legacy metadata compatibility contract.
