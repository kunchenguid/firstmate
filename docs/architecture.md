...
That policy routes product-facing, mixed, uncertain, and trust-boundary internal work through `no-mistakes`; only low-risk internal-only work takes `direct-PR`.
