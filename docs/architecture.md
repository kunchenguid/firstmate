...
An authoritative working verdict outranks either declaration and restores the wedge timer, and lifting the declaration returns the pane to ordinary wedge handling on the next poll.
