...
Worker-slot counts and SSH compute-host routing are a different contract, owned by `bin/fm-capacity-lib.sh` and `resource-aware-dispatch`; they do not select a harness or model.
