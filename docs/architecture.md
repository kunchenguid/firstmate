...
That keeps spawn launch compatible across claude, codex, grok, pi, pi-signed, opencode, kimi, and devin while preserving the requested profile for later audit.
