...
`data/projects.md` records each project's delivery mode and optional `+yolo` standing merge-approval flag; `AGENTS.md` section 7 owns the decision-authority contract.
