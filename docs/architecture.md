...
Teardown is fail-closed for ship worktrees: a dirty worktree refuses unless its content is proven to be nothing but a stale copy of an already-landed commit, and committed work must be landed before the worktree is returned.
