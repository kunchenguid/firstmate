...
Claude's residual active-turn window is covered by the durable wake queue plus the unchanged bounded turn-end guard, not by a watcher-status command gate.
