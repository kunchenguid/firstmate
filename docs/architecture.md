...
The merge helper's [header](../bin/fm-pr-merge.sh) owns forge invocation, merge-method defaults, and the no-mistakes final-evidence continuity check; [registration mechanics](../bin/fm-pr-check.sh) belong to the registration helper.
