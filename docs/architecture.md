...
For Cursor only, a changed rendered token count or context percentage is positive liveness and resets that wedge timer, while generic pane redraws do not.
