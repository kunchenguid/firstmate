...
Its `fm_nm_select_run` owns selection from the AXI run-identity overview and ambiguity reporting; `tests/fm-crew-state.test.sh` covers replacement gates, competing live runs, and preservation of newer failures.
