...
The merge-poll bound does not cover blockers, open decisions, failures, or deliveries without an armed poll; those retain their existing stale-wake routing, including any independently verified captain hold.
