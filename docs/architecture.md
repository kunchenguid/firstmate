...
It re-arms in full the moment that endpoint reads live again, so a replacement launched into the same window escalates as a wedge normally and its own later death is reported again.
