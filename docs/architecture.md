...
The update is fast-forward only: dirty, diverged, ahead (holding local commits not yet pushed to origin), offline, and off-default targets are reported and left untouched.
