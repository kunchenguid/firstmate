...
The arm wrapper also resets inherited ignored SIGHUP handling before installing cleanup traps, so harness validation modes that ignore SIGHUP do not leave orphan watcher children behind.
