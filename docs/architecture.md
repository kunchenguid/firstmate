...
A newest event that is itself one of those open decisions is emitted once and back-referenced, a newest line carrying no lifecycle verb is projected as an unrecognized legacy event, and the omitted count reports only events no record projected.
