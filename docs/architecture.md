...
A terminal passed run reports done as a completed validation run with the run's PR URL, never as a merged or closed pull request: only forge evidence, such as the validated merge poll, can claim that the work landed.
