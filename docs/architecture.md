...
A task named by a status file and every secondmate remain governed solely by the strict authoritative proof, while other eligible bare turn-ended tasks in the same batch may independently use pane-churn evidence.
