...
Both PR and local-only landing paths refuse an unanswered routing promotion before mutating the forge or project; `bin/fm-promotion-gate-lib.sh` owns that shared gate and its recorded last-resort override.
