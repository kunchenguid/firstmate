...
The optional Trello control plane uses the same additive watcher boundary; [trello-control-plane.md](trello-control-plane.md) owns its board semantics, generated artifacts, and polling contract.
