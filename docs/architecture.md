...
The private binding is tied to the current home, session-lock generation, owner PID, and process identity, while one outstanding record coalesces delivery for the bound session and recovery generation until the ordinary drain acknowledgement retires it.
