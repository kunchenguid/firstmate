...
Secondmate homes converge conservatively to the primary's version and declared inheritable configuration (including the post-worktree-create spawn hook) at launch and during locked session start.
