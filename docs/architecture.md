...
A pool worktree is only returned after teardown passes the slot-ownership proof: a contradictory task record or another durable ownership proof refuses before cleanup, and no discard authority relaxes that.
