...
That proof is either an exact semantic busy verdict that satisfies the crew classification below or advancing descendant CPU, and both carry the same bound.
