...
A replay conflict leaves the prior effective revision running and writes the `state/.nightly-update-needs-attention` alarm with the held id, upstream commit and subject, and collided paths.
