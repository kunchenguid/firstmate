...
The Shared Scope and Liveness Predicates section of [`turnend-guard.md`](turnend-guard.md#shared-scope-and-liveness-predicates) owns marker validation, plain-checkout detection, and required Firstmate-shaped paths.
