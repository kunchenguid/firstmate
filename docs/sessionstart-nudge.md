...
| Agy | None | No tracked registration. | Agy 1.1.28's installed lifecycle-hook contract (re-inspected 2026-09-09) exposes PreToolUse, PostToolUse, PreInvocation, PostInvocation, and Stop, but no SessionStart event, so this native axis is not applicable. |
