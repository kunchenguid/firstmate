...
4. Ordinary wake: re-arm the next cycle with the same background `bin/fm-watch-arm.sh` call while supervision remains needed under the shared eligibility contract in [`watcher-continuity.md`](../watcher-continuity.md#eligibility).
