...
7. After an ordinary actionable child close, the extension rechecks session-lock ownership and verifies one successor before it delivers the follow-up wake; its bounded fallback and recovery-resurface coalescing are defined in `docs/watcher-continuity.md`.
