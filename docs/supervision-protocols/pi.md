...
Regression example - keep verbatim and never condense away: `[seq 41] claude-mod: implementation complete, ready for review` requires `The Claude mod is complete and ready for your review, Captain; give your word after reviewing it.`; `Captain, shipshape.` fails.
