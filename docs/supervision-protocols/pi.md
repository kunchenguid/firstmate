...
A needs-decision signal makes its coalesced signal/stale trigger batch main-owned in whole.
Fleet-wide heartbeat scans remain independent and are never pulled to main merely because a needs-decision row is queued.
