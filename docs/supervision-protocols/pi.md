...
Completed scout signal and stale rows stay in this conversation so their report delivery, captain-call completion check, and guarded cleanup remain one task lifecycle under `AGENTS.md` section 7.
