...
While attended, completed-scout cleanup checks stay in this conversation so report review, captain-call inventory, and guarded teardown remain main-owned even when the branch reported the completion outcome.
