...
6. After an actionable child close, the extension rechecks session-lock ownership and verifies one successor before any follow-up delivery; `docs/watcher-continuity.md` owns the queue-revalidated fallback and coalescing boundary.
