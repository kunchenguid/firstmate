...
6. After an actionable child close, the extension rechecks session-lock ownership and verifies one successor before it delivers the wake through Pi's hidden watcher transport; `docs/watcher-continuity.md` owns the transport and bounded-fallback contract.
