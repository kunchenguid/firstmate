...
8. When the background task completes with `signal:`, `stale:`, `ratelimited:`, `check:`, or `heartbeat`, drain queued wakes, handle them, then start exactly one fresh background task.
