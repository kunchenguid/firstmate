...
8. The turn-end guard (`bin/fm-turnend-guard.sh --claude`) remains the final backstop.
   It uses the strict live-watcher and fresh-beacon predicate owned by [`turnend-guard.md`](../turnend-guard.md), distinct from the pull guard's one-shot handoff grace.
