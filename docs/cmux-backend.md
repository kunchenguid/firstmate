...
The composer verifier first recognizes Agy's separator-pair composer through the shared `fm_composer_separated_state` proof before the fleet-wide classifier runs.
