...
The composer verifier locates the last bordered composer or bare `→` row and delegates the content decision to `bin/fm-composer-lib.sh`; Cursor launches remain unsupported on cmux.
