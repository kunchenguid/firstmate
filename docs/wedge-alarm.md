...
Before the active channel existed, a wedged Herdr supervisor wrote only the passive `state/.subsuper-inject-wedged` marker.
...
The durable marker remains alongside the active alert.
