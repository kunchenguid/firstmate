...
Teardown also performs best-effort cleanup of browser bridges attributed to the task and its registered Lavish review-page pollers; the script header owns the scope and ordering.
