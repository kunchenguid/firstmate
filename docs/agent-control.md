...
Teardown also performs best-effort cleanup of the task-named browser session and its registered Lavish review-page pollers; the script header owns the scope and ordering.
