...
The refusal banner does not say that to the model, and deliberately says nothing about the detached start's prospects: it reports that the Stop-owned auto-arm did not claim this home, so nothing owns recovery and restoring supervision is on the reader.
