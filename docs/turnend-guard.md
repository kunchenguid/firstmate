...
- Codex registers a `Stop` hook in `.codex/hooks.json`, resolves its executable and worktree scope through the [trusted-root boundary](architecture.md#codex-project-hook-root-anchoring), and passes the original payload to the shared guard.
