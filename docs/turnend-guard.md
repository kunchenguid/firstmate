...
The guard first calls the shared primary scope, `fm_primary_scope_matches` in `bin/fm-primary-scope-lib.sh`.
Every root needs `AGENTS.md`, `bin/`, and the effective state directory.
