...
Its alarm marker is bound to the failure reset and authenticated failure claimant separately from any stale lock-owner mutation fence, so a predecessor session's alarm cannot suppress the successor's auto-arm or attended fail-open progression.
