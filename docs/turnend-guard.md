...
When that clearing cannot be recorded, supervision is healthy but the previous failure is not provably closed, so the guard holds the turn open rather than reporting recovery it cannot prove.
