...
It passes the running hook script's checkout, not `FM_ROOT_OVERRIDE` or an inherited `FM_HOME`.
A child crew or scout worktree that inherited the parent primary's environment therefore stays inert.
