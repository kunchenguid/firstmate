...
3. **Looks like a firstmate home.** `AGENTS.md`, `bin/`, and `state/` all exist at the resolved root - cheap defense in depth against the settings file somehow loading somewhere unrelated.
