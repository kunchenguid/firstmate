...
Routine supervision does not require attachment: `/bin/bash bin/fm-peek.sh <id>` captures a bounded tail and `FM_HOME=<home> /bin/bash bin/fm-send.sh <id> '<text>'` steers the recorded endpoint.
