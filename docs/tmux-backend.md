...
Fresh-spawn start-proof and dispatch-breaker behavior are owned by [`bin/fm-dispatch-breaker-lib.sh`](../bin/fm-dispatch-breaker-lib.sh) and covered by its circuit-breaker tests.
