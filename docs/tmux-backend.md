...
[`verification/runtime-backends.md`](verification/runtime-backends.md#tmux) records the active foreground-process, Cursor liveness and busy-signature, and submit evidence.
