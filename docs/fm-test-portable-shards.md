...
`tests/fm-routing-decision-negative-battery.test.sh` temporarily uses a conservative 60000 ms local hint instead of its pre-expansion 18000 ms value after the 100-case battery and parser-derived differential shell corpus measured 48217 ms on 2026-08-22; the next green CI timing refresh replaces this exception.
