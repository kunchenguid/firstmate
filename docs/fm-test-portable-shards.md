...
|---|---:|---:|
| `portable-parallel-1` | 11 | 104195 ms (~104.2 s) |
| `portable-parallel-2` | 10 | 104340 ms (~104.3 s) |
| imbalance | | 145 ms |
...
It keeps watcher, lock, AFK, real tmux, daemon, secondmate lifecycle, bootstrap, live-harness opt-in, and other unproven work serial.
