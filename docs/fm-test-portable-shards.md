...
`tests/fm-routing-decision-negative-battery.test.sh` temporarily uses a conservative 60000 ms local hint instead of its pre-expansion 18000 ms value after the 91-case battery measured 40889 ms on 2026-08-22; the next green CI timing refresh replaces this exception.
