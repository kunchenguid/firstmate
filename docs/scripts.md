...
| `fm-turnend-guard-cursor.sh` | Cursor stop-hook adapter for the primary turn-end guard                          |
| `fm-cursor-lib.sh`       | Shared owner of Cursor's user-level turn-end fallback hook install, lock, and last-task cleanup |
