...
| `fm-captain-wait.sh`     | Own durable home-scoped captain-wait arm, publish, clear, and notification dedupe      |
| `fm-codex-primary.sh`    | Launch a Codex primary with generic turn-completion notifications disabled             |
