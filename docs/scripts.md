...
| `fm-agenda-setup.sh`     | Provision the private business-agenda registry and its authenticated watcher check    |
| `fm-agenda-scan.sh`      | Emit locally due business-agenda items once per cadence period                        |
