...
| `fm-wake-drain.sh`       | Present durable watcher wakes with bounded OPEN DECISIONS and STATUS LINE ANOMALIES sections, consume only a generation-bound post-handling acknowledgement, then assert supervision health |
