...
| `fm-teardown.sh`         | Fail-closed teardown: return a task worktree only when no other task's branch owns it and it holds no unlanded work, require completed scout deliverables, retire secondmate homes |
