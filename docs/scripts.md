...
| [`fm-local-material.sh`](../bin/fm-local-material.sh) | Carry a project's configured untracked local material into a fresh ship or scout worktree, and render its worker-facing launch-brief section |
