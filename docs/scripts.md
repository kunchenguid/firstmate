...
| `fm-standing-worker.sh`  | Register adopted standing workers in plain Herdr panes and wake their supervisor when one stops working ([configuration.md](configuration.md) "Standing workers") |
