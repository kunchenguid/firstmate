...
| [`fm-remote-job-reap-orphans.sh`](../bin/fm-remote-job-reap-orphans.sh) | Reap abandoned remote workers and overdue lanes; its header owns eligibility and cleanup safeguards |
