...
| `fm-alert-count.py`      | Count the live Dependabot alerts an npm package-lock branch verifiably remediates, with per-alert exclusions and fail-closed NOT CHECKED rows |
