...
| `fm-dod-lib.sh`          | Render the shared ship review rule and mode-specific definitions of done for briefs and promotions |
...
| `fm-promote.sh`          | Promote a scout in place to a protected ship task with an explicit mode and shared ship review and delivery instructions |
