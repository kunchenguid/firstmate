...
| `fm-control.sh`          | Agent lifecycle control plane: allowlisted `interrupt`, `exit`, `relaunch`, and guarded `recover-missing` verbs for an exact task id ([agent-control.md](agent-control.md)) |
