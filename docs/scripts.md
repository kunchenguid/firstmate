...
| `fm-worktree-drift.sh`   | Catch a live ship or scout worker running outside its recorded worktree (such as a restored pane resumed in the primary checkout) and relaunch it into that worktree, re-registering its PR merge poll |
