...
| `fm-outward-text-check.sh` | Report identifiers no reader of the repository under change could resolve, before that text is published ([contract](outward-facing-text.md)) |
