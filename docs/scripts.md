...
| `fm-teardown.sh`         | Fail-closed teardown: return landed ship worktrees, require completed scout deliverables, retire secondmate homes; `--close-pane` retires an already-exited ship or scout pane without landing the copy |
