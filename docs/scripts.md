...
| `fm-bearings-snapshot.sh` | Project the bounded remote-ledger fleet snapshot to compact TOON, queue observed secondmate inventory reconciliation, and optionally add live GitHub enrichment with `--include-prs` |
