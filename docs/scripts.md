...
| `fm-update.sh`           | Fast-forward-only self-update of firstmate and local or remote secondmate homes from origin, plus detection (never merge) of whether the fork is behind its `upstream` remote |
