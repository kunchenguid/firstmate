...
| [`fm-dod-lib.sh`](../bin/fm-dod-lib.sh) | Own ship/scout worker role scope, direct ship definitions of done, and verification requirements |
...
| `fm-gate-refuse-lib.sh`  | Compatibility refusal for fleet mutation from a legacy no-mistakes gate context       |
