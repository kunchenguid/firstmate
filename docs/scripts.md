...
| `fm-branch-name-lib.sh`  | Single owner of a ship branch's name from its task id, shared by brief, spawn, and promotion, with the opt-in ticket-case canonicalization |
