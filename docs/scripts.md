...
| `fm-ensure-agents-md.sh` | Ensure a project's real `AGENTS.md`, its `CLAUDE.md` `@AGENTS.md` pointer, and self-governance guidance, leaving a project that keeps `AGENTS.md` alone untouched (shapes and explicit project mark documented in the helper's header and help) |
