...
| [`fm-parent-route-lib.sh`](../bin/fm-parent-route-lib.sh) | Single owner of the private parent-route directory shape inside a remote secondmate home, shared by the host-local control plane and the parent's charter-publishing seed |
