...
| `fm-tasks.sh`             | Render the compact task table and maintain private short references and human names |
| `fm-callsigns-lib.sh`     | Resolve canonical task ids, recyclable `t1`-`t99` references, and human names       |
