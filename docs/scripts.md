...
| `fm-watch.sh`            | Singleton-safe watcher: absorb benign wakes, detect stalled local-secondmate wake queues, merge a still-open PR whose task records `yolo=on`, and exit on actionable ones |
