...
| `fm-session-lock-lib.sh` | Shared session identity and liveness owner: verified Codex thread-writer flock first, then harness ancestry, for the home lock and its consumers |
