...
| `fm-codex-hook.mjs` | Cross-platform Codex SessionStart, Stop, and PreToolUse transport; POSIX delegates to existing shell owners, while native Windows imports policy owners directly and reports the POSIX-only bootstrap boundary |
