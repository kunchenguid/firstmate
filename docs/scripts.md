...
| `fm-pr-lib.sh`           | Own canonical task and PR validation, the fail-loud open pull request listing, private atomic PR-poll publication, and identity-bound retirement |
