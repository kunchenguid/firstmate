...
| `fm-continuation-check.sh` | Read-only accepted-work turn-settle check backed by tasks-axi eligibility            |
...
| `fm-inactive-reconcile.sh` | Quietly reconcile direct-report progress and long-inactive terminal outcomes without forge access |
