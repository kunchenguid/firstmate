...
| `fm-primary-resource.sh` | Main-session resource protection: observe/arm/check/decide/commit/helper for context and quota handover; private state under `state/primary-resource/` |
