...
| `fm-hygiene-audit.sh`    | Report leftover state that needs cleanup (stale copy claims, unowned dirty pool copies and unlanded branches, lagging clones) without changing anything |
