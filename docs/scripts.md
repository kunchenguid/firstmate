...
| `fm-decision-hold.sh`    | Create, verify, complete, resolve, decline, repair, and classify durable captain-held decisions |
| `fm-decision-ledger.sh`  | Emit the read-only decision-coverage ledger with enumerated, disposition-bearing open keys |
