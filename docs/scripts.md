...
| `fm-hygiene-audit.sh`    | Report leftover state that needs cleanup (stale copy claims, unowned dirty copies and unlanded branches, lagging clones) without changing anything |
