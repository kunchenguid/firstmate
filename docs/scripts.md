...
| `fm-fleet-sync.sh`       | Refresh project clones with safe fast-forwards, self-heals, proof-guarded convergence onto a rewritten default branch, `STUCK:` reports, branch pruning, and bounded recovery from an orphaned `.git/packed-refs.lock` |
