...
| `fm-busy-event.sh`       | The only writer of a task's semantic busy-state record and inside-a-turn harness progress marker; arms an incarnation and applies lifecycle events |
