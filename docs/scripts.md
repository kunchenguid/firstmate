...
| `fm-session-lock-lib.sh` | Numeric-harness ancestry and holder-liveness predicates for the Claude Stop auto-arm |
...
| `fm-lock.sh`             | Typed per-home firstmate session lock and atomic stale-owner reclaim                 |
