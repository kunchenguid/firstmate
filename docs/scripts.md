...
| `fm-afk-alarm.sh`        | Own the away posture's supervisor-failure channel: the loud local marker and the captain-held record that replace waking the parked main |
