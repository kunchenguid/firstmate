...
| `fm-gh-read.sh`          | Build, plan, verify, and attended Cursor PATH install for the native GitHub read helper |
| `fm-gh-read-lib.sh`      | Protected Cursor helper PATH checks sourced by spawn and fm-gh-read.sh |
