...
| `fm-parallelism.sh`      | Resolve or persist the standalone non-enforcing WorkGraph parallelism mode            |
| `fm-workgraph.sh`        | Validate and present a digest-bound one-node WorkGraph and slice contract              |
