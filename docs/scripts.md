...
| `fm-preflight-gate.sh`   | Pre-dispatch admission gate proving push path, delivery path, quota headroom, and host concurrency before a ship spawn ([architecture.md](architecture.md)) |
