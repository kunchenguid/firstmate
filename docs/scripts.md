...
| `fm-worktree-ownership-lib.sh` | Shared fail-safe proof that a recorded worktree still belongs to its task, plus the claim and owner-marker retirement lifecycle |
