...
| `fm-teardown.sh`         | Fail-closed teardown: return landed ship worktrees, remove exact worktree-labeled Compose containers, require completed scout deliverables, retire secondmate homes |
