...
| `fm-tmux-lib.sh`         | Shared tmux pane primitives for busy detection, composer capture, verified submit, and composer clearing for the away-mode force-deliver path |
