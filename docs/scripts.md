...
| `fm-afk-launch.sh`       | Own away-mode entry (same-turn record write, then read-back), quiet-mode entry without that record, exit, rollback, and any backend terminal lifecycle |
