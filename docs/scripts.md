...
| `fm-pr-merge.sh`         | Record PR metadata, merge a task's canonical full GitHub, GitLab, or Bitbucket Cloud URL, then refuse an outcome it cannot prove landed or queued |
