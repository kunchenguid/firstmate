...
| `fm-fleet-board.sh`      | Operate the loopback-only always-on fleet Kanban application                         |
| `fm-task-risk.sh`        | Record Firstmate's explicit low, medium, or high task-risk assessment                 |
