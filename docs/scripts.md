...
| `fm-runpod-watchdog.sh`  | Detached killswitch that terminates a rented RunPod pod at the deletion deadline its run declared, verifying the stop by listing the account's pods ([runpod-pod-watchdog.md](runpod-pod-watchdog.md)) |
