...
| `fm-fleet-sync.sh`       | Refresh project clones with shallow-history repair, safe fast-forwards, self-heals, `STUCK:` reports, branch pruning, and bounded lock recovery |
