...
| `fm-pr-state.sh`         | Read-only: report visible GitHub PR blockers or collect task-level live GitHub PR and worker evidence with guarded review and merge verdicts |
