...
| `fm-merge-authority-lib.sh` | Resolve, from the away-posture record and the task's recorded yolo posture, which authority permits or permitted a task's merge |
