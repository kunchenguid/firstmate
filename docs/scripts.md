...
| `fm-teardown.sh`         | Fail-closed teardown: release landed ship worktrees through their recorded provider, require completed scout deliverables, retire secondmate homes |
