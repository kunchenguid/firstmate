...
| `fm-liveness-guardian.sh` | Session-independent systemd-timer supervision backstop: re-arm a lapsed watcher self-survivingly, relaunch a dead local director, or escalate (docs/liveness-guardian.md) |
