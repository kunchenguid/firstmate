...
| `fm-telegram-send.sh`    | Drain the outward notification outbox to Telegram, and arm or disarm that drain                     |
| `fm-telegram-lib.sh`     | Own the outward notification cards: what one may contain, when it is refused, and how it is queued  |
