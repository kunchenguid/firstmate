...
| `fm-nixbuild-usage-check.sh` | Probe each nixbuild.net free-tier account's CPU-second quota over SSH and report accounts at or above the warning threshold or unreachable |
