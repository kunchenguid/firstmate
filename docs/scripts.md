...
| [`fm-competition-scientist-lab.sh`](../bin/fm-competition-scientist-lab.sh) | Explicitly run the inert [synthetic competition-scientist pilot](examples/competition-scientist/README.md) |
