...
| `fm-session-lock-lib.sh` | Shared session-lock harness ancestry, process-state classification, and immutable owner-group leases for fm-lock.sh and the Claude Stop auto-arm |
