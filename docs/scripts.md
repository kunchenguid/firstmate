...
| `fm-cursor-lib.sh`       | Single owner of Cursor executable resolution and legacy-alias proof, Cursor process identity, and the shared spawn/teardown process-identity parse |
