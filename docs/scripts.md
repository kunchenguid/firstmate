...
| `fm-lavish-dock-check.sh` | Standing Lavish dock-reply copy: `arm` registers a watcher check that copies unseen dock Send prompts into this home's captain inbox without `lavish-axi poll`, `disarm` removes it |
