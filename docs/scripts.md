...
| `fm-unified-library.sh`  | Read-only adapter for OSBAMBAM Unified Library search, open, and trace plus brain.js memory recall; prints library-owner commands for every write (`unified-library` skill owns when to use it) |
