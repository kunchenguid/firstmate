...
| `fm-turnend-guard-agy.sh` | Agy Stop-hook adapter for the primary turn-end guard                                |
| `fm-agy-turnend-hook.sh` | Validate and signal one token-bound Agy crew turn end                                 |
