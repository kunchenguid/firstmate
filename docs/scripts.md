...
| `fm-teardown.sh`         | Fail-closed teardown: return landed ship worktrees, require completed scout deliverables, retire secondmate homes, refuse a worktree slot another live task's record or the treehouse pool still claims |
