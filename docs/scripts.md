...
| `fm-primary-scope.sh`    | Identify a main or valid secondmate primary home                                     |
...
| `fm-lock.sh`             | Classify, inspect, and atomically acquire the per-home firstmate session lock         |
