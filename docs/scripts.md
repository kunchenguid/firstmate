...
| `fm-project-mode.sh`     | Resolve a project's registered delivery posture for mechanical consumers            |
...
| `fm-tangle-lib.sh`       | Shared default-branch, lifecycle-base, and primary-checkout tangle resolution         |
