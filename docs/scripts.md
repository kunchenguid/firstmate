...
| `fm-dispatch-resolve.sh` | Ask Jev through OpenRouter to resolve one typed dispatch recommendation                |
| `fm-jev.sh`              | Inspect or atomically change this home's Jev dispatch posture                          |
