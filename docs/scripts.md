...
| `fm-review-sweep-supervisor.sh` | Schedule and durably run the private nt-review-sweep skill in an isolated automation home ([configuration.md](configuration.md#scheduled-review-sweep-supervisor)) |
