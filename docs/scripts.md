...
| `fm-primary-resource.sh` | Main-session resource protection: observe/arm/check/commit/helper for context and quota handover; private state under `state/primary-resource/` |
