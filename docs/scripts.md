...
| `fm-wake-drain.sh`       | Atomically drain and custody-version queued wakes, emit bounded status annotations and a fleet-wide OPEN DECISIONS section, then assert watcher liveness |
