...
| `fm-completed-view-lib.sh` | Own opt-in Herdr completed-view config, bounded summaries, exact records, and retention |
| `fm-completed-view.sh`   | List or explicitly dismiss retained completed-task Herdr views                       |
