...
| `fm-lavish-dock-check.sh` | Automatically armed primary-home Lavish dock-reply copy; the watcher copies queued prompt occurrences and the owned poll adapter publishes consumed feedback into the captain inbox |
