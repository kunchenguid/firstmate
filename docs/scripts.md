...
| `fm-grok-trust.sh`       | Classify a bounded Grok pane capture as a waiting project-folder trust frame (`active`) or one a later session surface has retired (`superseded`) |
