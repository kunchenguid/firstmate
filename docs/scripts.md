...
| `fm-lavish-review.sh`    | Open private Lavish reviews and arm task feedback polling                            |
| `fm-lavish-poll.sh`      | Run one bounded Lavish feedback poll for a registered task check                     |
