...
| `fm-herdr-operations-console.sh` | Render the opt-in, fixture-first, display-only Herdr operations console ([herdr-backend.md](herdr-backend.md#fixture-operations-console)) |
