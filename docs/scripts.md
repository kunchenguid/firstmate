...
| `fm-teardown.sh`         | Fail-closed teardown: return landed ship worktrees, require completed scout deliverables, retire secondmate homes; `--record-only` archives a completed record whose pooled slot another task already reused |
