...
| `fm-present-report.sh`   | Create or explicitly open a static local HTML projection of canonical Markdown or a Bearings snapshot |
...
| `fm-claude-captains-call-shortcut.mjs` | Map exact trusted interactive Claude prompts to the project-owned Bearings skill |
