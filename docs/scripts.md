...
| `fm-status.sh`           | Append timestamped task/run/session-correlated status events                         |
| `fm-observe.py`          | Collect privacy-safe local task metrics and render the static dashboard              |
