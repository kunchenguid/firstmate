...
| `fm-watch-checkpoint.sh` | Run one bounded foreground watcher checkpoint; the Codex bridge's bounded fallback                |
| `fm-watch-codex-bridge.sh` | Codex-primary persistent watcher bridge: arm, tracked-terminal owner, and verified wake-doorbell injection ([watcher-continuity.md](watcher-continuity.md#codex-bridge-ownership)) |
