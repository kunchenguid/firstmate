...
| `fm-mail.sh`             | Mail client and offline template preview; see [Mail plane](configuration.md#mail-plane-env) for behavior and configuration, and the script's help for commands and the template schema |
