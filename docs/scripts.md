...
| `fm-github-write.sh`     | Derive and validate one direct-PR publication or autonomous GitHub merge from authoritative task and project records |
| `fm-github-write-av.sh`  | Declare the content-bound Automic Vault capabilities for the bounded GitHub write path |
