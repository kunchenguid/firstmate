...
| `fm-cost-summary-lib.sh` | Write each non-secondmate task's `data/<id>/cost.json` close-out consumption summary at teardown, from frozen intake identity and list-price USD harness session totals |
