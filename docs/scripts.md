...
| `fm-project-mode.sh`     | Resolve a project's registered delivery posture by name or path from `data/projects.md` for fleet sync, home seeding, and spawn notices |
