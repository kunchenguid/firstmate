...
| `fm-tasks-axi.sh`        | Run one routine tasks-axi command against the active Firstmate home's backlog        |
...
| `fm-tasks-axi-lib.sh`    | Shared backlog-backend selector, home-bound invocation, and compatibility probe      |
