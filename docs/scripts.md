...
| `fm-landed-lib.sh`       | Shared "has this content already landed?" containment test, default-branch name, and landing-target candidate refs |
...
| `fm-pr-merge.sh`         | Forge-verify landing identity, then merge a task's canonical full GitHub URL         |
