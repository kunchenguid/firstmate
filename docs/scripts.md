...
| `fm-decision-reconcile.sh` | Link backlog work to operating policies, resolve duplicate holds, and retire inactive items |
| `fm-routine-complete.sh` | Verify and execute routine ship completion after the verification gate           |
