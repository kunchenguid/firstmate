...
| `fm-ff-lib.sh`           | Shared guarded fast-forward helper for origin pulls and secondmate syncs, plus the one selector for a remote command's own diagnostic line |
