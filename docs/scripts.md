...
| `fm-consult.sh`          | Prepare, submit, collect, and reconcile private one-shot ChatGPT Pro advisory consultations |
...
| `fm-procevent-consult.sh` | Wait for and handle known consultation jobs through nonblocking process-event wakes |
