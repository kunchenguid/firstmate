...
| `fm-pr-merge.sh`         | Record PR metadata, then merge a task's canonical full GitHub, GitLab, or Gitea/Forgejo URL, then refuse an outcome it cannot prove landed or queued |
