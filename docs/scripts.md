...
| `fm-watch.sh`            | Singleton-safe watcher: absorb benign wakes, detect stalled local-secondmate wake queues, apply the [attended-only yolo merge contract](../bin/fm-pr-merge.sh), and exit on actionable ones |
