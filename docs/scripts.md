...
| `fm-update.sh`           | Per-home-policy self-update of firstmate and local or remote secondmate homes          |
...
| `fm-ff-lib.sh`           | Shared tracked-code convergence helper for origin updates and local secondmate syncs |
