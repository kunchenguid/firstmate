...
| `fm-dod-lib.sh`          | Own the ship task's mode-specific delivery contract shared by brief scaffolding and scout promotion |
| `fm-push-scan.sh`        | Scan PR publication surfaces against one explicitly selected home-local company or sensitive term list |
