...
| `fm-dashboard.sh`        | Lifecycle for the live fleet dashboard HTTP sidecar (start / stop / status / run)    |
| `fm-dashboard-server.py` | Stdlib HTTP server for the dashboard (invoked by `fm-dashboard.sh`, not by hand)     |
