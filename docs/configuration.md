...
Grok `xhigh` is valid only when the profile names one of the models listed in the [Grok reference](../.agents/skills/harness-adapters/references/harness/grok.md); a profile that omits `model` is rejected.
