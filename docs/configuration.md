...
FM_SNAPSHOT_CREW_STATE_TIMEOUT=10   # seconds bounding the complete local status and current-state observation phase inside bin/fm-fleet-snapshot.sh; remote endpoint liveness is not probed on the snapshot path
