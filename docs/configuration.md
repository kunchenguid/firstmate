...
FM_TREEHOUSE_AUDIT_TIMEOUT=10   # seconds allowed for bootstrap's whole read-only dirty-idle pool sweep across the firstmate repo and every project clone; unset/blank/non-numeric defaults to 10
