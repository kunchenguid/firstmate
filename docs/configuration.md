...
Successful cleanup stops only the recorded named session after the task's landed-work or report/decision checks pass; legacy records never fall back to the default session.
