...
FM_CONTINUITY_GAP_GRACE=1800   # seconds a canonical latest-cycle delivered-wake owner row keeps accounting for a missing watcher in the Claude continuity PreToolUse gate
...
FM_WATCH_CYCLE_LOG_KEEP_LINES=1000   # newest complete canonical lifecycle rows considered when the ledger is capped
