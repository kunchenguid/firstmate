...
FM_CLAUDE_GUARD_ARM_CONFIRM=5   # seconds the --claude guard's last-resort arm waits for the watcher it spawned to pass the strict predicate before falling back to the bounded re-block; the arm itself is never budget-limited
