...
FM_SPAWN_LAUNCH_CONFIRM_TIMEOUT=30   # whole seconds fm-spawn.sh waits for a pane to confirm it ran the staged launch command before failing the spawn; invalid values fall back to 30
