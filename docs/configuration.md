...
The layout manifest in [.claude/rules/layout-and-state.md](../.claude/rules/layout-and-state.md) routes the branch's runtime files to their format and lifecycle owners.
