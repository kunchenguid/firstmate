...
FM_WATCH_REARM_RETRY_BASE_MS=250   # Pi/OpenCode adapter base delay for successor-restoration and wake-queue-lock revalidation retries
FM_WATCH_REARM_RETRY_MAX_MS=4000   # Pi/OpenCode adapter cap for successor-restoration and wake-queue-lock revalidation retry delay
FM_WATCH_REARM_RETRY_LIMIT=5   # Pi/OpenCode adapter retry limit before surfacing restoration or queue-lock revalidation failure
