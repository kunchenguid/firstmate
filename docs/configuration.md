...
FM_CODEX_BACKGROUND_WAKE=  # set verified/supported after local Codex wake-on-exit smoke; set unverified/unsupported/degraded to force degraded watcher supervision
