...
FM_SUPERVISOR_REFRESH_SECS=5  # zellij-only: seconds between supervisor-pane redraws; blank, non-numeric, or 0 uses 5 (docs/zellij-backend.md "Supervisor surface"; unrelated to the away-mode FM_SUPERVISOR_BACKEND/FM_SUPERVISOR_TARGET pair below)
