...
FM_LOOP_PROBE_SECS=60              # minimum seconds between the looping check's gate-state reads of one busy pane; episode age starts with its first observed busy parked state
