...
For chrome-devtools-axi work against an internal app gated by SSO, see [`docs/chrome-auth-persistence.md`](chrome-auth-persistence.md) for the persistent-profile login convention that lets crewmates run headless without prompting for credentials.
