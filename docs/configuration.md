...
FM_TMUX_LAYOUT=window   # 'window' (default) spawns one fm-<id> tmux window per task; 'pane' splits firstmate's current window and records pane= (requires running inside tmux)
