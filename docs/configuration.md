...
FM_LANE_MIN_AVAILABLE_RAM_GB=1 # refuse new spawns below this available-RAM line (Linux MemAvailable; macOS free + speculative + inactive pages); 0 disables the RAM threshold
