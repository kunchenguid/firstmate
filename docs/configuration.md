...
FM_CLAUDE_AUTOARM_LOCK_CLAIM_WAIT_MS=2000   # extra milliseconds added to the sync wait when the session lock is unowned, covering the arm's fm-lock.sh claim; see docs/turnend-guard.md
