...
Hermes is verified only as a primary and is never accepted by the worker launch path; [`docs/hermes-primary.md`](hermes-primary.md) owns its setup, required Pi worker and Herdr backend policy, launch, verification, and limits.
