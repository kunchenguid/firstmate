...
claude, codex, opencode, pi, grok, kimi, and cursor-agent are empirically verified for crewmate and secondmate launches; [README requirements](../README.md#requirements) own the narrower set supported for the primary session.
