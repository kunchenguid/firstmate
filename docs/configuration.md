...
claude, codex, opencode, pi, and grok are all empirically verified, and cursor is verified as a crewmate/scout-only adapter; new harnesses get verified through a supervised trial task before joining the set.
