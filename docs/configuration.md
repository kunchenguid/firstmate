...
FM_TOPIC_REMIND_SECONDS=300   # seconds before a pending topic item is surfaced again
FM_TOPIC_CLAIMED_REMIND_SECONDS=14400   # seconds before a claimed topic item is surfaced again
...
FM_TEARDOWN_LANDED_REMOTE=   # optional remote URL or configured remote name whose freshly verified default branch may prove this task HEAD has landed
FM_TEARDOWN_LANDED_REMOTE_TIMEOUT=10   # seconds allowed for each remote landing-proof command inside fm-teardown.sh
