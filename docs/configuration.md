...
FM_WATCH_EXTENSION_LOG_KEEP_LINES=200   # newest rows kept in the Pi extension diagnostic log (state/.watch-extension.log); logging never changes supervision behavior
