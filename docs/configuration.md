...
FM_AFK_HERDR_CLI_TIMEOUT_SECS=2   # positive whole-second hard deadline per Herdr supervisor transport call made by the away-mode daemon, including an active delivery during shutdown; invalid or zero uses 2, while worker reads and non-away Herdr callers remain unchanged
