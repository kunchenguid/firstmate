...
FM_COMPOSER_IDLE_RE=    # optional empty-composer regex, applied after ghost and border stripping; the away-mode daemon defaults it to cursor's idle placeholder ('^Add a follow-up$') under a cursor firstmate
