...
FM_CODEX_WATCH_CHECKPOINT=180   # 1..540 seconds per foreground watcher checkpoint in Codex primary supervision; higher values cap at 540 to leave margin under the 600-second Stop-hook timeout
