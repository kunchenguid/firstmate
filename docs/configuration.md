...
FM_WATCHER_SHUTDOWN_LOCK_SECS=5   # seconds a signalled watcher may wait for the recovery-marker lock before it stops anyway and reports what it could not persist; invalid or zero values use 5
