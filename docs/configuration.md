...
`data/` holds durable private fleet records such as the project and secondmate registries, captain preferences, optional shared captain preferences, learnings, backlog, briefs, scout reports, and optional per-task structured captain decisions.
[`docs/captain-hold-lifecycle.md`](captain-hold-lifecycle.md) owns the structured captain-decision record and read-projection contract.
