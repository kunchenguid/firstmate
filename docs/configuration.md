...
FM_MAIN_HEALTH_TIMEOUT=20      # wall-clock seconds allowed for each gh api call fm-main-health.sh makes; a value that is not a positive integer falls back to the default
