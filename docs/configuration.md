...
On that home, `/afk` launches no away daemon, and `/quiet` launches one only where the attended host cannot run ([supervision-host.md](supervision-host.md#quiet-mode)).
