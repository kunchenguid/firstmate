...
FM_TASK_INBOX_RING_MAX=3      # watcher delivery attempts (rings or composer-protected skips) without an acknowledgement before the task surfaces as a stale wake for recovery
