...
Hermes is verified only as a primary and is never accepted by the worker launch path; [`docs/hermes-primary.md`](hermes-primary.md) owns its setup, local worker selection, launch, verification, and limits.
