...
Claude and Grok use background-notify cycles, Codex uses bounded foreground checkpoints, Pi and OMP use their tracked primary extensions, and OpenCode uses its TUI plugin.
