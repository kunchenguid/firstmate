...
FM_FLEET_SYNC_BOOTSTRAP_TIMEOUT=     # optional seconds override for bootstrap's best-effort clone refresh; unset/blank uses the fleet-size default owned by bin/fm-bootstrap.sh
