...
FM_BACKEND_RYDER_ENV_REMOVE='CLAUDE_CODE_CHILD_SESSION CLAUDECODE GROK_AGENT'  # ryder-only: inherited harness markers scrubbed from a new session's environment
