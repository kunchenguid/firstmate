...
FM_COMPOSER_PI_MAX_LINES=8     # fleet-wide: maximum rows admitted between an identity-corroborated separator pair (pi, agy); taller or ambiguous candidates stay unknown
