...
FM_CODEX_BACKGROUND_WAKE=verified|unverified   # optional Codex supervision override; leave unset unless docs/turnend-guard.md's background-wake smoke has been run
