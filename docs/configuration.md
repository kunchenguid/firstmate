...
FM_ARM_CONFIRM_TIMEOUT=60   # seconds fm-watch-arm waits to confirm a fresh watcher before reporting FAILED, covering a large post-downtime backlog sweep; same default on Git Bash/MSYS
