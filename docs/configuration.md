...
Successful producer invocations automatically gain durable capture, duplicate coalescing, prompt supervision wakes, and restart replay through Firstmate's existing process-event machinery.
