...
FM_CLAUDE_AUTOARM_SYNC_WAIT_MS=800   # milliseconds of elapsed wall clock the --claude turn-end guard waits for watcher health, the auto-arm's in-progress or role-verified claim, or a fresh epoch before deciding recovery ownership or failure progression
