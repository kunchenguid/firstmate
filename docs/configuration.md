...
FM_DONE_GUARD_FORGE_SECS=5  # seconds bounding each forge read the ship-done gate makes while confirming a PR-requiring done line (bin/fm-done-guard-lib.sh); a hit bound refuses that completion rather than accepting it
