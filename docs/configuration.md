...
While a live away-mode daemon owns this home the daemon owns the watcher and its default cadence applies; away-mode Relay cadence is a deferred follow-up.
