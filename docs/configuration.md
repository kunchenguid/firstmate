...
For Pi-family launches, [`fm-spawn.sh --help`](../bin/fm-spawn.sh) owns the required scoped project-resource approval, compatibility refusal, and optional regular-TUI safeguard.
