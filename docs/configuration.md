...
omp (Oh My Pi) is a candidate crewmate/scout adapter rather than a verified one, and it must not receive real work until its separately approved first live pilot passes.
