...
FM_WINDOW_HOUSEKEEPING_SECS=3600  # 300..86400-second cadence and inactivity threshold for closing recorded dead endpoints after fm-crew-state reports done or failed
FM_WINDOW_HOUSEKEEPING_MAX=20     # maximum task records considered by one finished-window housekeeping pass before the cursor resumes on a later watcher poll
