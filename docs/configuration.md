...
FM_LOCK_STEAL_MAX_DEPTH=2   # nested ".steal" mutexes fm_lock_try_acquire will chase to reclaim a dead owner before failing closed instead of recursing further
