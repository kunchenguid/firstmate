...
FM_DRAIN_UNRECOGNISED_MAX=10  # unrecognised status lines printed per drain in UNREAD STATUS; the rest are counted and held back to the next drain rather than dropped, and 0 prints the count alone
