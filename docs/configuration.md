...
FM_WATCH_CYCLE_LINK_HORIZON_S=300   # seconds an outstanding successor-link claim under state/.watch-cycle-links stays applicable before it is retired unapplied; zero or invalid values use 300 (docs/watcher-continuity.md owns the claim mechanism)
