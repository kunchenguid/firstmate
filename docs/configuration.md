...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before an idle external wait (declared paused: or pane-derived) re-surfaces for a recheck in the watcher or away-mode daemon; also the re-probe cadence for a pane-derived pause's liveness check
