...
The decision-hold completion gate uses that configured archive as durable resolved-decision history after an identity is pruned from the active backlog; [`docs/decision-hold-lifecycle.md`](decision-hold-lifecycle.md) owns its exact acceptance and failure behavior.
