...
FM_CLAUDE_TURNEND_READONLY_ADVISORIES=2   # read-only advisories a lock-refused --claude session gets before the turn-end guard stands down for that session; 0 stands down immediately
