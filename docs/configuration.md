...
For captain-facing outcome visibility and bounded processing retries, see [Pi supervision branch: Two-stage noise filter](pi-supervision-branch.md#two-stage-noise-filter).
