...
A completely idle home cannot promptly consume these events through a supported repository boundary; periodic fleet sweeps or operator-owned manual scheduler invocation provide interim coverage without blocking use of the ingress.
