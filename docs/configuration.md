...
FM_WATCHER_STALE_GRACE=300   # defaults to FM_GUARD_GRACE; seconds a live watcher lock may have a stale beacon before a forked child treats it as wedged (a plain arm self-heals that wedge; this bounds only the child's own stale-lock refusal)
