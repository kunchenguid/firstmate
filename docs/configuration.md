...
FM_CURSOR_AUTH_ENV=$HOME/.config/crew-router/env  # cursor ship/scout auth file; must exist and define CURSOR_API_KEY, while cursor secondmates do not read it
