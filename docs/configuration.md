...
FM_BACKEND_HERDR_PROOF_READS=3  # herdr-only: most composer reads, one caller settle apart, before a Claude payload that may still be drawing is refused (docs/herdr-backend.md "Claude composer proof")
