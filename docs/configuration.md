...
That conclude records the acknowledgement before it retires the board and undoes it again if the retirement fails, so the one ownership record is never dropped while its round is still open.
