...
[Pi supervision branch delivery](pi-supervision-branch.md#two-stage-noise-filter) owns captain-outcome persistence, processing-request pacing, and acknowledgement boundaries.
