...
NM_HOME=~/.no-mistakes  # no-mistakes home where fm-crew-state.sh locates a run's gate worktree object database when judging an advanced nonterminal run head for staleness
