...
A single trailing newline is accepted; an empty value, a leading dash, a slash anywhere, whitespace, multi-line content, CRLF endings, or a symlinked or otherwise non-regular file is refused loudly before any consumer acts.
