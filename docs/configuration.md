...
Auto-detected Herdr stays silent like tmux, while auto-detected cmux or paseo prints a stderr notice naming `config/backend` and `--backend tmux` because both remain experimental.
