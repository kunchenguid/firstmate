...
FM_GIT_LIVE_REMOTE_OPERATION_TIMEOUT_SECS=15   # seconds allowed for one non-interactive Git operation while proving remote delivery
FM_GIT_LIVE_REMOTE_BUDGET_SECS=45   # total seconds allowed for one delivery proof, including all destinations and PR-acceptance retries
