...
FM_AFK_HERDR_CLI_TIMEOUT_SECS=2   # positive whole-second hard deadline per Herdr CLI call for away-mode injection and shutdown; invalid or zero uses 2, while non-away Herdr callers remain unchanged
