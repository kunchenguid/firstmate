...
FM_CONTINUITY_GAP_GRACE=1800   # seconds Claude's continuity gate allows an owner-recorded delivered-wake handling gap before refusing fleet commands again
