...
FM_STALE_ESCALATE_SECS=240         # idle seconds before a provably-working stale pane escalates; leftover idle surfaces once, then exponential backoff capped at once per hour; dead+done and dead+paused stay silent after classify
