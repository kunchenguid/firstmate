...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before an idle declared external wait, verified captain-held transfer, or still-open keyed captain decision re-surfaces for a recheck in the watcher or away-mode daemon
