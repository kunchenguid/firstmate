...
Routine delivery - including the silent no-change heartbeat and the unchanged-repeat filter that keeps a repeated note out of main's context - is owned by [docs/pi-supervision-branch.md](pi-supervision-branch.md).
