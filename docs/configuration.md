...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before away-mode or secondmate supervision re-surfaces an idle declared external wait; an ordinary normal-mode worker is deduplicated by its task-bound pause state
