...
Hermes is verified only as a primary and is never accepted as a named worker harness; [`docs/hermes-primary.md`](hermes-primary.md) owns its setup, local worker selection, launch, verification, raw-command boundary, and limits.
