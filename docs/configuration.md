...
FM_DECLARED_WORK_STALL_SECS=900    # seconds a secondmate's unresumed declared work may sit on an idle endpoint before it surfaces as a stall; a declared pause, a terminal last event, or a proven-busy endpoint never counts
