...
Because the check persists, an routine-only primary home still requires the ordinary watcher supervision cycle, and each invocation remains bounded by `FM_CHECK_TIMEOUT`.
