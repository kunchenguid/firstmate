...
FM_SNAPSHOT_SECONDMATE_TIMEOUT=15  # aggregate seconds allowed for one local or remote secondmate-home summary, including transport
FM_SNAPSHOT_SECONDMATE_STATE_TIMEOUT=3  # seconds allowed for the one coarse no-mistakes run inventory reused across a home summary's children
