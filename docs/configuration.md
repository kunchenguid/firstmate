...
Forgejo pull-request watches and merges additionally require a compatible `forgejo-axi` on `PATH`; `fm-pr-check.sh` refuses to arm a Forgejo watch when it is unavailable.
