...
FM_INACTIVE_RECONCILE_SECS=900  # 60..1800-second bounded cadence for inactive terminal-outcome reconciliation in the existing watcher poll and locked session start
