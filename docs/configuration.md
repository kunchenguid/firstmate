...
Composer 2.5 is not an adapter and cannot appear in crew harness or dispatch-profile configuration; [`docs/cursor-composer.md`](cursor-composer.md) owns its narrower Codex-managed specialist boundary.
