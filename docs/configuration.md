...
FM_WATCHER_STALE_GRACE=300   # defaults to FM_GUARD_GRACE; arm health threshold, with an identity-matched live holder waited on for roughly half this value and never replaced because of beacon age
