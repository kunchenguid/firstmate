...
FM_PI_TURNEND_BLOCK_BUDGET=3   # consecutive Pi turn-end guard follow-ups before the extension degrades to one visible warning; any healthy turn resets it
FM_PI_TURNEND_GUARD_TIMEOUT_MS=15000   # milliseconds the Pi extension waits for its turn-end guard spawn before killing it and failing open
FM_PI_PRETOOL_CHECK_TIMEOUT_MS=10000   # milliseconds the Pi extension waits for a PreToolUse checker spawn before killing it and allowing the tool call
