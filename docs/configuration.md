...
FM_OVERLOAD_REGEX='API Error: 529'   # overload footer line signature, also full-line matched; a match is parked with the shorter FM_OVERLOAD_FALLBACK reset, since overloads are transient
