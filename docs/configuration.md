...
A tmux task additionally records `tmux_window_id=` as its stable retirement identity; legacy records without it fall back to the exact recorded window name.
