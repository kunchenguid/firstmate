...
Teardown makes a best-effort usage harvest before removing task state; the [harvester header](../bin/fm-usage-harvest.sh) owns the private ledger format and collection limits, and [fm-usage-report.sh](../bin/fm-usage-report.sh) reads it.
