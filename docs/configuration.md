...
FM_STALE_CAPTURE_RETRIES=2         # extra away-mode housekeeping capture attempts after the first failure before a gone/unreadable verdict (bin/fm-supervise-daemon.sh)
FM_STALE_CAPTURE_RETRY_SLEEP=0.4   # seconds between those extra capture attempts
