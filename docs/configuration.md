...
[`docs/gh-read-helper.md`](gh-read-helper.md) owns Cursor ship and scout GitHub routing, and [`bin/fm-gh-read.sh`](../bin/fm-gh-read.sh) owns its install and verification commands.
