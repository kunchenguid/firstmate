...
FM_PROC_ROOT_OVERRIDE=   # alternate /proc root for every Linux process-identity read in bin/ (session-lock, wake, cursor, and teardown identity), mainly for tests
