...
FM_WEDGE_DEMAND_INSPECT_COUNT=3    # successive acknowledged provably-working stale escalations on the same unchanged pane before demand-deep-inspection is added; an equivalent queued and unacknowledged stale does not advance the count
