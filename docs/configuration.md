...
FM_PROCEVENT_LIVE_SETTLE_SECONDS=2      # unbroken seconds the exact source must stay live before arm reports ready; accepted range 1-300, and a confirmation timeout below it never confirms
