...
Muse's [adapter reference](../.agents/skills/harness-adapters/references/harness/muse.md#credential-preflight) owns worker-reachable credential setup, including the subscription requirement for `max` effort.
