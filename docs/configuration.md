...
FM_ATTEST_NM_TIMEOUT=20   # seconds allowed per no-mistakes run-record read inside fm-attest.sh; a read that hits the bound refuses as run-record-unreadable (docs/no-mistakes-attestation.md)
