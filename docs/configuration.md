...
FM_GUARD_GRACE=300      # seconds before guard warnings, arm health checks, and the primary turn-end guard treat a watcher beacon as stale; the pull guard exempts only a session-bound active Claude rewake turn
