...
[Routine outcome visibility](pi-supervision-branch.md#two-stage-noise-filter), including silent no-change task reviews, is owned by the supervision branch contract.
