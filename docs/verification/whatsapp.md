...
| 3. Andamento durante tarefa longa | Regressões cobrem tarefa ativa anterior a onze conclusões, reply encerrado, pedidos recebidos/enfileirados/reivindicados e desambiguação; consulta após completed de 200000 caracteres verifica resumo limitado, cursor avançado, reinício e resultado integral preservado; a execução longa é simulada. |
