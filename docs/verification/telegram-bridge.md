...
The focused suite covers protected config modes, regular-file and no-symlink/no-hardlink checks, post-publication failure preservation, exact local pairing, authorized and unauthorized updates, strict update ordering and deduplication, persist-before-offset crash recovery, live-session wake ownership, exact approval correlation and publication recovery, durable request retirement, sent-receipt finalization recovery, outbound receipt states and tombstones, definite rejection versus ambiguous delivery, diagnostic redaction, immutable receive-time retention, isolated watcher deadlines, quiet event filtering, and malformed, oversized, edited, and media inputs.
