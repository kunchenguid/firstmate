...
In daemon-owned supervision, this delivery ends the watcher cycle exactly like the existing check path and leaves classification to the daemon; `bin/fm-watch.sh` owns posture-dependent triage.
