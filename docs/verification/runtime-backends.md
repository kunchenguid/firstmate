...
[Grok 1.0.13 interrupt verification](grok-interrupt.md) records three qualifying Escape cancellations and a separate Ctrl+C control without changing the busy regex.
