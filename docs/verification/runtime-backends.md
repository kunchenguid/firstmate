...
The destroyed-endpoint case also executes the recovered Pi command and verifies the nested startup directory, native model/effort, and unchanged root identity after Herdr endpoint replacement.
