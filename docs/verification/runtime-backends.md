...
[Grok mid-turn Enter](grok-queued-enter.md) records the 2026-09-06 real-CLI queueing result for Grok 1.0.13, its manual refresh commands, and the observed footer mismatch; it does not refresh the composer-classification matrix.
