...
omp 18.1.18 rewrites that process title: on macOS `ps -o comm=` then reports the argv[0] spelling `OMP` while the kernel name stays `omp`, and both spellings are accepted (verified live on 18.1.18, 2026-09-12).
