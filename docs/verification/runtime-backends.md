...
The same command also covers missing-pane refusal: `fm-control relaunch` keeps the prior record when Herdr cannot atomically exclude restoration of the original pane.
