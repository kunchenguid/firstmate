...
A run of plain rows below a proven envelope (`Working on request...`) holds no bare candidate, is therefore not furniture, and goes on invalidating the envelope above it exactly as before.
