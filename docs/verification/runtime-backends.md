...
The live evidence is recorded against gate tip `30f3d426`; later cleanup, race-documentation, unused-helper, Zellij fallback, and multiline-note changes are covered by portable regressions, and the final-tip live re-run remains pending in [`docs/verification/agy.md`](agy.md).
