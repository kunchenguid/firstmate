...
The change is confined to the Herdr submit owner, so Pi and pi-signed use the Pi-specific branch while Claude, Codex, OpenCode, Grok, Kimi, Cursor, Muse, tmux, Zellij, Orca, and cmux retain their existing submit paths.
