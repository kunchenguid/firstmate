...
The Muse launch clears `CLAUDECODE`, `PI_CODING_AGENT`, `GROK_AGENT`, `ANTIGRAVITY_AGENT`, and `FM_PI_HARNESS` before the worker starts so foreign harness markers cannot override the versioned ancestry.
