...
[`../watcher-continuity.md`](../watcher-continuity.md#regression-coverage) owns that suite's full case list, including the recovery-episode cases that pin the once-per-down-stretch announcement bound.
