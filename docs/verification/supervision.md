...
The same suite pins both directions with real processes: an unowned or recycled pid is reclaimed with a note naming the process that had been holding the home, while a recorded live owner still refuses a second session and keeps a competing Stop hook inert.
