...
A lock outside that ancestry is decided by the session-cohort proof instead, whose per-harness evidence lives in [`runtime-backends.md`](runtime-backends.md#session-lock-identity-and-the-suspended-holder).
