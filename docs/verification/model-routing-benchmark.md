...
A restore-drill fixture proves that a perturbed archived evaluator's stderr cannot forge an extra `BENCH_CHECK` or `BENCH_RESULT` line in the gate's line-oriented output.
