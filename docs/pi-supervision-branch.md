...
- Captain autonomy grant: `config/pi-supervision-branch` (docs/configuration.md "Pi supervision branch"). The branch is disabled without the exact home-local value `on`; absence never assumes consent.
