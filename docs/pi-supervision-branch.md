...
Its "PR identity: copy or abstain" section owns where a PR URL in a summary or tool argument may come from: a durable record, verbatim, or else only the identifier the branch actually has.
