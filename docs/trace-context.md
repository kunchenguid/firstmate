...
The injection sits at the unconditional pre-launch export site, so it covers every accepted ship, scout, and secondmate spawn; [harness configuration](configuration.md#harness-support) owns adapter eligibility.
