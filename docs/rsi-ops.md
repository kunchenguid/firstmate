...
The ledger schema and event meanings are owned by the locked consensus, including the rule that final production success is `prod_verified` rather than bare `prod`.
