...
Claude, Codex, OpenCode, Pi, pi-signed, Prime Agent, Grok, Kimi, Cursor, Gemini, Muse, Rovo, and omp therefore expose no package-loading surface for this capability.
