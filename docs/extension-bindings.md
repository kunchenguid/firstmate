...
Claude, Codex, GitHub Copilot CLI, OpenCode, Pi, pi-signed, Grok, Kimi, Cursor, Muse, Rovo, and omp therefore expose no package-loading surface for this capability.
