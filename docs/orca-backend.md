...
Every task lane, scout and ship alike, still refuses dirty or unlanded work, an uninspectable recorded worktree path, and a worktree held by another task's branch.
