...
Ordinary scout teardown calls the read-only `verify` subcommand after checking for the report and before removing any source state; [configuration](configuration.md#runtime-backend-configbackend--fm_backend) owns the reportless recovery exceptions.
