...
Ownership paths must be ASCII because neither case sensitivity nor byte equality proves Unicode normalization variants are distinct on every supported filesystem.
