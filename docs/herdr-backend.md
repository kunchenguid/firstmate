...
The [Muse verification record](verification/runtime-backends.md#submit-confirmation) covers the native-idle route and composer limitation observed on the verified versions.
