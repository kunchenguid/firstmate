...
A namespace whose reported owner differs from this account while this account can still create entries inside it is reported as an untrustworthy account id rather than as a foreign one, because no removal or rerun clears that.
