...
Both of those are OBSERVERS, so both enter through one function, `fm_afk_canary_resolve`; hand-rolling the sequence twice is how they drift into disagreeing about the same supervisor.
