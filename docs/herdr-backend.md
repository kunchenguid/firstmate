...
The repositioning move-to-last preserves every surviving workspace's relative order, and an unconfirmed removal makes one verified attempt under the same session lock to roll the doomed workspace back to its exact original position.
