...
- Busy-queued Enter and idle-native composer confirmation are owned by `fm_composer_queued_enter_verdict` and this adapter's native fallback; see Current transport behavior.
