...
The adapter locates the bottom-most recognized bordered row, Claude `❯` row, Codex `›` row, a Cursor `→` row (verified live on herdr 2026-08-05, cursor-agent 2026.07.23-e383d2b), or a Pi separator region admitted only when native identity is exactly Pi and state is idle, done, or blocked.
