...
Inherited tmux variables that do not describe the pane this process runs in fall through to Herdr; [`configuration.md`](configuration.md#runtime-backend-configbackend--fm_backend) owns that rule.
