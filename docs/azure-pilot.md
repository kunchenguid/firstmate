...
The script inventories every VM, OS disk, task-state disk, and provider-account disk before mutation, refuses unknown or oversized inventories, and bounds every Azure cleanup call with a configurable 60-to-3,600-second deadline.
