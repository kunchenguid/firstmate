...
`bin/fm-supervision-lib.sh` also recognizes a secure-mode Relay poll as supervision need, but unaccounted primary work still contributes nothing to that predicate.
