...
`bin/fm-supervision-lib.sh` also recognizes an X-mode relay poll or a registered custom check as supervision need, but unaccounted primary work still contributes nothing to that predicate.
