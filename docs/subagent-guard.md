...
`bin/fm-supervision-lib.sh` also recognizes a Relay poll or an armed inbound message channel as supervision need, but unaccounted primary work still contributes nothing to that predicate.
