...
firstmate is the command layer, not the workshop: task validation belongs to the worker, broad regression coverage belongs to CI, and merge policy belongs to the configured authority.
