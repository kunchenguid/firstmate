...
- [docs/azure-devops-merge-watch.md](docs/azure-devops-merge-watch.md) - maintainer verification for watching Azure DevOps pull requests on arbitrary organisations.
