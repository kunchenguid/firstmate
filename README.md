...
| `/updatefirstmate` | Self-update ordinary mirrors with safe fast-forwards, or verify and explicitly install a compatible optimized prompt overlay on newer upstream code, then re-read instructions and nudge secondmates |
