...
A captain decision that is due now appears only under decisions even when its own task has parked awaiting the answer, and one deferred to a future hold-until date appears only under waiting until that date arrives.
