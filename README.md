...
- **Explicit project modes** - each project ships via `no-mistakes`, `direct-PR`, or `local-only`, with independently settable `+yolo` autonomy grants for answering review findings, merging PRs, and approving local landings.
