...
- **A visible crew** - every crewmate works in its own tmux window or Herdr tab, or in an experimental Zellij tab, experimental cmux workspace, experimental Orca terminal, or experimental T3 Code thread you can watch or interact with; the first mate reconciles.
