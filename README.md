...
- **Explicit project modes** - each project ships via `no-mistakes`, `direct-PR`, `local-only`, or `gate-merge`, with an optional `+yolo` autonomy flag.
