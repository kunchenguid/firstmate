...
That recently-resolved panel is main-home only in v1: the canonical secondmate home summary omits a secondmate's completed captain-held rows, this board does not widen that contract, and a project owned by a secondmate says so on the card.
