...
- A verified primary agent harness: Claude Code, Grok, Pi, `pi-signed`, Codex, OpenCode, or AGY.
...
- [docs/dashboard.md](docs/dashboard.md) - start and optionally auto-start the read-only local fleet dashboard.
