...
| `/lavish`          | Build and open a Lavish visual report or review board through the real `lavish-axi` path - HTML under `.lavish/`, never a Claude artifact or other host - arming captain feedback when appropriate |
