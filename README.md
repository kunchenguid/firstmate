...
FM_WATCH_KEEPALIVE_CRASH_THRESHOLD=5  # failed re-arms within the crash window before backoff
FM_WATCH_KEEPALIVE_CRASH_WINDOW=60    # seconds for keepalive crash-loop accounting
