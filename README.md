...
| `/debrief`         | Generate a five-section session debrief in chat, written in ASD-STE100 Simplified Technical English: what the workers did, what was fixed and found, the effect on the project, open action items, and decisions required |
