...
A completed row still held for the captain is a transfer record rather than landed work or a pull-request link, while a captain hold that is still in flight keeps its pull-request link.
