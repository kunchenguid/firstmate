...
| `/updatefirstmate` | Guardedly sync an applicable GitHub fork, then fast-forward Firstmate and its secondmates from the configured origin, converge inherited config, and refresh instructions |
