...
| `/user-journey-audit` | Audit an app as isolated new and returning users against a local test instance, preserve evidence, and present prioritized defects, UX improvements, and grounded feature ideas without filing follow-up work before approval |
