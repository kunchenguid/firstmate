...
- **Explicit project modes** - each project ships via `no-mistakes`, `direct-PR`, or `local-only`, with an optional `+yolo` posture that makes created PRs ready for review and grants merge autonomy.
