...
| `/memory-clerk`    | Review allowlisted durable Firstmate records and publish a bounded private curation proposal without changing canonical memory or operational records |
