...
A captain-actionable queued row is shown as a decision rather than repeated under queued next steps, and a completed row still held for the captain is a transfer record rather than landed work or a pull-request link.
