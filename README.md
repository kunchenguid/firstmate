...
- **Optional Trello control plane** - opt in with one local board config to mirror fleet state and turn captain-owned Inbox and Ready moves into supervised task requests and decisions without changing non-Trello behavior.
...
- [docs/trello-control-plane.md](docs/trello-control-plane.md) - configure the optional board dashboard and captain command surface.
