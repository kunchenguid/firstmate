...
- [docs/gh-image-evidence.md](docs/gh-image-evidence.md) - why ship crewmates attach visual PR evidence with the `gh-image` extension, and the verified headless constraints behind its graceful degradation.
