...
| Skill              | What it does                                                                                                                                  |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `/afk`             | Record your away instructions and keep supervision running while you step away. See the [afk skill](.agents/skills/afk/SKILL.md) for harness-specific supervision and return handling |
| `/quiet`           | Batch routine updates while staying and chatting; ordinary messages preserve quiet mode, and `/quiet off` exits it. See the [quiet skill](.agents/skills/quiet/SKILL.md) for harness-specific supervision |
