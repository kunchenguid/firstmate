...
| `/updatefirstmate` | Compare the configured fork origin with canonical upstream, fast-forward the running firstmate and its secondmates only to a history containing both, then re-read instructions and nudge secondmates |
