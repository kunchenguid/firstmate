...
| `/pr-shepherd`     | Gate an open PR to a landable state: inventory reviews, disposition every comment, drive critical CI green, report honestly, and merge only under captain merge authority; use `--no-merge` for report-only |
