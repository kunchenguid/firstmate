...
| `/quiet`           | Reduce routine wake turns while you stay and chat, keep attended supervision without afk state on Pi and pi-signed, reuse the afk daemon lifecycle on other harnesses, and exit only for the exact `/quiet off` command |
