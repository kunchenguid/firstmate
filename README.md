...
- **Optional overnight quiet hours** - opt in to a configurable blackout window (default 18:00-05:00 America/New_York, DST-aware) during which supervision burns zero autonomous tokens and auto-resumes at the end, extendable on demand; captain messages are never gated.
