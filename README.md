...
- **Exact work identity** - optionally bind a task before dispatch to stable, versioned project or initiative, plan, stage, work-unit, and source-system IDs that survive instructions and fleet views without title or label inference.
...
- The [universal toolchain](docs/configuration.md#toolchain), including Git, an authenticated GitHub CLI, and Python 3.
...
- [docs/work-identity.md](docs/work-identity.md) - current operator flow for exact task project or initiative, plan, stage, work-unit, and source-system identity.
