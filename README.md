...
A bounded-read drop in the canonical snapshot, and a secondmate whose state can reach no registered project at all, are disclosed board-wide rather than quietly shrinking a card.
