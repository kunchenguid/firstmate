...
The Calm-hidden operational inputs remain ordinary user-role messages with unchanged delivery, ordering, authority, persistence, and exports.
Pi watcher notifications instead use a non-displayed custom-message transport, so raw watcher instructions and private paths never render in captain chat.
