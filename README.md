...
| `/moss-pr`         | Apply the Moss feature and PR quality bar for intent, surface coverage, bounded hardening, artifact lockstep, review-thread closeout, and GO/NO-GO attestation |
