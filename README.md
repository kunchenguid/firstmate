...
- [docs/state-directory-layout.md](docs/state-directory-layout.md) - full field-by-field inventory of `state/`.
- [docs/agent-only-reference-skills.md](docs/agent-only-reference-skills.md) - the full agent-only reference-skill trigger list.
- [docs/relay.md](docs/relay.md) - the public-mention Relay integration: activation, wake handling, and public-reply commitments.
