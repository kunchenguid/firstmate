...
- **A visible crew** - every crewmate works in its own tmux window, Herdr tab, or experimental zellij tab, cmux workspace, thurbox session, or Orca terminal you can watch or type into; the first mate reconciles.
...
- [docs/thurbox-backend.md](docs/thurbox-backend.md) - current setup, event push, and limits for the experimental thurbox backend.
