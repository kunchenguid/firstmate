...
- [docs/project-memory.md](docs/project-memory.md) - where a project's knowledge actually lives, what never travelled into its clone, how material that cannot be committed still reaches a worker, and the project recipe catalog every spawn digests.
