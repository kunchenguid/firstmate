...
A completed row still held for the captain is a resolved decision, listed in a bounded recently-resolved panel under decisions rather than mixed into landed work or pull-request history, while a captain hold that is still in flight keeps its pull-request link.
