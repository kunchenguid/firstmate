...
| `/handoff`         | Review this conversation only and print a pasteable next-session starter of still-relevant work so the captain can `/clear` and resume; writes nothing to disk (unlike `/stow`) |
