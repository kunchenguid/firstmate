...
- [docs/agent-control.md](docs/agent-control.md) - lifecycle controls, shared same-home message threads, daily structured transport telemetry, and the `fm-message.sh stats` summary.
