...
- [docs/system-map.md](docs/system-map.md) - maintainer map of the Pi extensions, shared lib modules, and internal and public skills, and how they connect to scripts, state, and docs.
