...
- **Guarded by construction** - the first mate is read-only over your projects outside idempotent gate setup/refreshes, guarded clone refreshes, safe branch pruning, and approved `local-only` fast-forward merges; crewmates make every project change behind your merge approval.
