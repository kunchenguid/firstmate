...
- **Captain-facing fleet dashboard** - [`bin/fm-dashboard.sh`](bin/fm-dashboard.sh) generates a self-contained HTML view of live task states, stage-based progress, pending decisions, watcher health, queued wakes, and backlog items.
