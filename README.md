...
Firstmate ships these user-invocable built-in skills and commands.
...
| `/tasks`           | Show a compact Ref, Name, Status, and Current outcome table; pass a `t1`-`t99` reference or task name to filter it |
