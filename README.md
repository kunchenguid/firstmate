...
- [docs/resource-guard.md](docs/resource-guard.md) - maintainer architecture, policy, local schemas, safe-pause boundary, bounded review loop, and private weekly-review feed for per-task resource budgets.
