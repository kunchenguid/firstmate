...
- **Restart-proof** - all state lives on disk and in the selected or detected session backend (tmux, herdr, zellij, Orca, or cmux); kill the session anytime and the next one reconciles, including confirmed-dead secondmate agents, and carries on.
