...
**Status:** applied on branch `patch/wedge-cap-2026-08-19` (off main).
...
**Upstream report:** see the message text in this session's chat history (the note drafted for `kunchenguid/firstmate` issue/PR). If the maintainer accepts a similar fix on main, this patch can be dropped and the branch deleted.
