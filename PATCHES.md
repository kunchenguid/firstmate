...
**Status:** applied on branch `patch/wedge-cap-2026-08-19` (off main). v6 (2026-08-25) addresses Greptile review round 5: lift the cap marker on unambiguous recovery (`pause_state_class = working`), without re-introducing the v2-v4 over-clearing on every pause-class transition.
