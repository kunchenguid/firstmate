...
A change to any surface that merge authority rests on is carved out from every standing relaxation and always needs a fresh explicit captain word for that PR; hard rule 2 owns the full list of carved-out surfaces.
