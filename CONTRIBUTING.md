...
- This repo is a template for running a firstmate orchestrator agent.
  [`AGENTS.md`](AGENTS.md) owns the supervisor contract, role boundary, and bundled firstmate skill triggers; `.claude/skills` is a symlink to `.agents/skills`.
...
[ ! -e CLAUDE.md ]   # migrated into AGENTS.md; must not exist
