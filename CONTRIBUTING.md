...
- Helper scripts in `bin/` are plain bash.
  ...
  The [internal-voice refusal section of the architecture guide](docs/architecture.md#internal-voice-refusal-before-the-first-push) owns the guard run through that default path.
