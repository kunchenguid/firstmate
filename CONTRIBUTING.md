...
A local `--all` walk is not expected to be perfectly clean; see [known pre-existing test failures](docs/verification/known-test-failures.md) before assuming a failure there is caused by your branch.
