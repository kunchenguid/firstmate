...
Once that check succeeds, the recorded attestation remains valid for explanatory body edits while the PR head is unchanged.
A code change produces a new head and requires the marker to be present and checked again.
