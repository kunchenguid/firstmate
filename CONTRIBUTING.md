...
tests/fm-watcher-lock.test.sh             # watcher singleton, lock-race, PID identity stability (locale-invariant, clock-independent procfs form, recycled-pid distinction, old lstart-format lock compat), watch-arm liveness, and guard-warning tests
