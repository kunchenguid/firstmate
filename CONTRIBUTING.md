...
tests/fm-watcher-lock.test.sh             # watcher singleton, lock-race, PID identity stability, watch-arm liveness, wedged-incumbent arm self-heal, and guard-warning tests
