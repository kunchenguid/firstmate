...
A change to the merge authority itself - hard rule 2, the captain-instruction precedence section, or the `pr-shepherd` skill's merge-authority section - is carved out there and always needs a fresh explicit captain word for that PR.
