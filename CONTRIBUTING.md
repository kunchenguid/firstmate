...
If automated corrections advance the PR head after that attestation was written, rerun validation from the new head so no-mistakes replaces the stale attestation; never hand-edit the attestation or push around the gate.
