...
bin/fm-test-run.sh --changed   # conservative changed-file-informed set (serial; never silent full suite)
bin/fm-test-run.sh --changed --jobs auto --max-wall-ms 300000   # explicit bounded fast path with a five-minute guard
