...
tests/fm-hooks.test.sh                    # post-worktree-create spawn hook seam: absent no-op, args/env contract, primary-checkout refusal, non-fatal hook error, and FM_HOOK_TIMEOUT bound with kill-after grace
