...
A task's caller-supplied `REPO` value cannot establish that it will touch firstmate's shared tracked material, so firstmate adds this skill's load line to relevant firstmate-repo briefs by hand.
