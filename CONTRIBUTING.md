...
If this check fails, return to the branch and push it through the gate so no-mistakes writes the complete `## Pipeline` section; do not paste the signature into the PR body by hand.
