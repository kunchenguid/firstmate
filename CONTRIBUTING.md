...
tests/fm-spawn-cwd.test.sh                # --cwd ship/scout subdirectory sessions: relative-path/no-'..'/--secondmate argument rejection, cwd_subdir= meta recording, live-pane cd landing, and harness-independence
