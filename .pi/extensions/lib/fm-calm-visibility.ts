...
// Calm is on or off. Assistant text remains visible even when it immediately precedes
// a tool call, so the conversation stays intelligible while presentation-only rows hide.
