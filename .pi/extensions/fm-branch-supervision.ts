    ...
    return {
      ...
      parameters: Type.Object({
        ...
        silent: Type.Optional(Type.Boolean({
          description: "True only when a supervision review found literally nothing worth reporting and took no action (a fleet-wide heartbeat review or a task-local wake that changed nothing); omit or use false whenever any action was taken or any routine result is worth a note",
        })),
      }),
...
${context.command}
  ...
  // routine note uses except an explicitly silent no-change review.
