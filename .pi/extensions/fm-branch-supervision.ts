    ...
    return {
      ...
      parameters: Type.Object({
        ...
        silent: Type.Optional(Type.Boolean({
          description: "True only when the review found no new outcome, took no action, and found nothing worth reporting, including unchanged completed work retained for a preview; omit or use false for new results or actions",
        })),
      }),
