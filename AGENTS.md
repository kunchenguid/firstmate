...
state/               runtime records and signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .paused-* .wedge-escalations-* .run-progress-* .run-superseded-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
