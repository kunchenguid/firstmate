...
config/agy-turnend-hook  captain's one-time consent for the global agy turn-end hook write: "allow" permits it, "deny" refuses it, absent means he has not been asked and is the only case that asks; LOCAL, gitignored, and not inherited; see docs/configuration.md "agy turn-end hook consent"
