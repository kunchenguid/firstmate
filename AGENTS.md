...
config/t3-primary  optional presence flag (optional first line = thread uuid or thread_id=<uuid>) enabling T3-hosted Cursor primary park via t3cli; LOCAL, gitignored, not inherited by default; see docs/t3-primary-supervision.md
