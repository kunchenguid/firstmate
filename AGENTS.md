...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-handoff.lock .claude-autoarm-epoch .turnend-claude-blocks   Claude Stop auto-arm single-flight, queued handoff, epoch, and guard-budget records; never touch
