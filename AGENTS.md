...
config/github-accounts.json  optional strict non-secret per-project GitHub account routing; LOCAL, gitignored, inherited by secondmate homes; docs/configuration.md owns the full schema and guarded command contract
