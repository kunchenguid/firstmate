...
config/endpoint-binding-recovery-allow  optional record-pinned authorization lines for cleanup-time legacy endpoint-binding recovery from an out-of-home project; LOCAL, gitignored; see docs/configuration.md "Runtime backend"
