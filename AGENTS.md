...
- `read-only-pr-review` - load before scoping, dispatching, or evaluating a captain-requested deep pull-request review that must return findings and action items without changing project or forge state.
