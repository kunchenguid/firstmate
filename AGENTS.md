...
config/brief-addendum.md  optional Markdown appended verbatim to every scaffolded ship and scout brief as a final "# Home rules" section; LOCAL, gitignored, and not inherited; see docs/configuration.md "Brief addendum"
