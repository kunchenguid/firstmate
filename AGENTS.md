...
config/wedge-defer-pipeline  optional presence flag opting this home into the default-off deferral of a wedge escalation for a lane whose validation pipeline reports one of its own steps still producing output; LOCAL, gitignored, and inherited by secondmate homes; see docs/configuration.md "Pipeline-activity wait deferral"
