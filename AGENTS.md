...
config/pi-delegated-profile  optional delegated Pi model, effort, and compaction policy; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Delegated Pi profile"
