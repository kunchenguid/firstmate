...
config/pr-dressing-audit.json  optional per-repository pull request rules read by bin/fm-pr-dressing-audit.sh; LOCAL, gitignored, and NOT inherited by secondmate homes; see docs/configuration.md "Pull request dressing audit"
