...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-transition.lock .claude-autoarm-epoch .claude-autoarm-failure-epochs/ .claude-autoarm-failure-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock   Claude Stop auto-arm single-flight, identity-fenced transition serialization, claim epoch, immutable claim-failure records plus legacy record, failure-episode, attended-alarm, guard-budget, and budget-lock records; never touch
