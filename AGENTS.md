...
Use `gh-axi` for GitHub, `chrome-devtools-axi` for browser work, and `lavish-axi` for the captain-facing visual surfaces section 9 owns; consult current help rather than memorizing flags.
