...
state/               runtime records and signals; gitignored
  ...
  <id>.herdr-presentation  quarantinable attempt and restart-binding journal for Herdr's optional visual projection, moved into quarantine/ once proven stale; never task or endpoint authority; see docs/herdr-backend.md "Presentation spaces"
