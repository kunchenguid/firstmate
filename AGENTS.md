...
state/               runtime records and signals; gitignored
  ...
  <id>.githooks/     per-task commit-msg hook refusing agent co-author trailers in the task's local copy; installed by fm-spawn, removed by teardown (bin/fm-commit-trailer-lib.sh)
