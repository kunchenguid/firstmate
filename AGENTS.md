...
state/               runtime records and signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .paused-* .wedge-escalations-* .writing-* .fg-pid-* .fg-since-* .fg-resurfaced-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
