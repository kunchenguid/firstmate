...
config/captain-event-outbox  optional exact `enabled` line for the private Pi semantic captain-event journal; LOCAL, gitignored, and not inherited; see docs/configuration.md "Semantic captain-event outbox"
...
state/               runtime records and signals; gitignored
  ...
  captain-events/  optional private `fm-captain-event.v1` Pi primary/worker semantic journal, pending publication state, and consumer ingestion receipts; bin/fm-captain-event.sh owns the format
