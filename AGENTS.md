...
config/backend  runtime session-provider backend override for new tasks; LOCAL, gitignored, and inherited by secondmate homes under the primary-authoritative contract in secondmate-provisioning; docs/configuration.md "Runtime backend" owns selection, defaults, notices, and recorded-metadata compatibility
