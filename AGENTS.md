...
config/claude-account config/pi-account  explicit worker account selection for managed Claude and Pi launches; LOCAL, gitignored; absent refuses rather than spending an ambient account; not inherited; see docs/configuration.md "Worker accounts"
