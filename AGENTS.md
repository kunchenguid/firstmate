...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-transition.lock .claude-autoarm-epoch .claude-autoarm-failure-sequence/ .claude-autoarm-failure-reset .claude-autoarm-failure-resetting .claude-autoarm-failure-epochs/ .claude-autoarm-failure-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock   Claude Stop auto-arm single-flight, identity-fenced transition serialization, claim epoch, monotonic failure/reset fencing and its in-progress transaction, immutable claim-failure records plus legacy record, episode-fenced notice election, attended-alarm, guard-budget, and budget-lock records; never touch
