...
The generic effort fallback and its precedence are owned by the [model and effort reference](.agents/skills/harness-adapters/references/common/model-and-effort.md) in `harness-adapters`.
