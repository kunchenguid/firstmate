...
.cursor/skills/calm  symlink to ../../.agents/skills/calm so Cursor discovers /calm as a project skill
...
config/calm     Calm presentation preference shared by the Pi extension, the Claude Code mod, and Cursor's /calm skill; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
