...
state/               runtime records and signals; gitignored
  ...
  .watch-codex-bridge.lock .watch-codex-bridge-terminal .watch-codex-bridge-binding .watch-codex-bridge-delivered .watch-codex-bridge.log .watch-codex-bridge.pid .watch-codex-bridge.watch.err   Codex-primary watcher bridge singleton, launch record, and delivery state; bin/fm-watch-codex-bridge.sh's header owns the contract (docs/watcher-continuity.md "Codex bridge ownership")
