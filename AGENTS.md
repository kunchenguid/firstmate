...
state/               runtime records and signals; gitignored
  ...
  .context-restart-crossing .context-restart.lock  Claude's versioned threshold-crossing/ready sentinel and single-flight publication lock; owned by bin/fm-context-restart-lib.sh and never touch
