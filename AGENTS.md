...
config/treehouse-root  treehouse pool root for this home's ship/scout worktrees; LOCAL, gitignored; absent = treehouse's own default root, which every clone of one remote shares; not inherited by secondmate homes; see docs/configuration.md "Treehouse pool root"
