...
state/               runtime records and signals; gitignored
  ...
  procevent/         registered process-to-event sources plus adapter-private transient input, one source id namespace; written only by process-event scripts, and registrations alone keep supervision required (section 13)
