...
state/               runtime records and signals; gitignored
  ...
  <id>.herdr-launch  narrow structural-launch attempt and replacement binding retained only across an uncertain Herdr plain-Pi launch; see docs/herdr-backend.md "Plain-Pi structural launch"
