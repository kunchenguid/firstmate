...
state/               runtime records and signals; gitignored
  ...
  .codex-autoarm.lock .codex-autoarm-epoch .codex-autoarm-failure-notified .codex-autoarm-failure-alarmed   Codex Stop auto-arm single-flight, epoch, failure-episode, and attended-alarm records, sharing the guard-budget pair above with Claude's; never touch
