...
- `firstmate-orca` - load before Orca-backed task work or when deciding whether Orca work belongs to Firstmate lifecycle helpers or the version-matched `orca-cli` skill.
