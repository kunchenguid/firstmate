...
state/               runtime records and signals; gitignored
  ...
  .tmp-sweep-stamp .tmp-sweep-last  daily unowned /tmp scratch sweep stamp and last one-line result; bin/fm-tmp-sweep.sh is the only writer; deleting the stamp makes the next watcher cycle due
