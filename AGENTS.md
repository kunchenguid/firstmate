...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  projects.md        thin fleet navigation registry recording each project's standing delivery posture and any working branch that is not the remote default; firstmate-private, parsed for mechanical sync, seeding, and spawn worktree placement by fm-project-mode.sh (section 6)
