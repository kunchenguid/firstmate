...
Every ship and scout brief must retain the container-cleanup clause: a worker that starts containers names them `fm-<task-id>-*` and stops and removes them before reporting done.
