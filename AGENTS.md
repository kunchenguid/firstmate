...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  task-telemetry.tsv  durable one-row-per-completed-task token and difficulty ledger; LOCAL, gitignored (docs/configuration.md "Task telemetry")
