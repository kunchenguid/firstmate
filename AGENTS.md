...
state/               runtime records and signals; gitignored
  ...
  lavish-dock.check.sh  generated Lavish dock-reply shim and its .check-trust binding; present only after bin/fm-lavish-dock-check.sh arm; report record .lavish-dock-check and forwarded-uid cursor .lavish-dock-seen (docs/configuration.md "Lavish dock replies")
