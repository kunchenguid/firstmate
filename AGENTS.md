...
state/               runtime records and signals; gitignored
  ...
  .cursor-park-owner .cursor-park-owner.lock .cursor-followup-offer .turnend-cursor-blocks   Cursor stop-hook owner record, publication and commit lock, outstanding watcher follow-up slot, and bounded repair-nag budget; never touch
