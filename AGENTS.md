...
config/codex-fabric-mcp  optional presence flag authorizing default-off, process-only Fabric credential delegation to spawned Codex workers; LOCAL, gitignored, and not inherited; see docs/configuration.md "Codex Fabric MCP credentials"
