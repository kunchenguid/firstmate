...
state/               volatile runtime signals; gitignored
  ...
  <id>.submit-disagreement  append-only semantic-vs-rendered submit-confirm disagreement evidence written by bin/fm-tmux-lib.sh; removed by teardown
  <id>.submit-lock/  transient per-task send-serialization lock owned by bin/fm-tmux-lib.sh; stale-broken automatically; removed by teardown
