...
state/               runtime records and signals; gitignored
  ...
  procevent-quota-reset/  private task-bound rolling-quota-reset watch records binding task, run, provider, window, and baseline reset identity; written only by bin/fm-procevent-quota-reset.sh (section 13's process-event-sources trigger)
