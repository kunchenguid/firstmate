...
state/               runtime records and signals; gitignored
  ...
  <id>.agy-turnend-token   firstmate-owned Agy hook registry token, customization root, root ownership, and installed-hook provenance record for the task; removed by teardown
