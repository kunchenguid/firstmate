...
- `harness-handoff-recovery` - load when a Claude or Codex usage window ends and Firstmate supervision or an ordinary in-flight worker must continue on the other harness.
