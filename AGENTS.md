...
bin/fm-spawn.sh <id> projects/<repo> --backend codex-app --harness codex # experimental Codex Desktop thread backend (docs/codex-app-backend.md); uses git worktree + status-file handshake; no secondmates yet
