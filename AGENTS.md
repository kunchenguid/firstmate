...
config/pi-delegated-profile  optional delegated Pi model, effort, and compaction policy inherited by secondmate homes; see docs/configuration.md "Delegated Pi profile"
