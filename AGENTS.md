...
config/wedge-defer-pipeline  optional presence flag opting this home into the default-off deferral of a wedge escalation while the validation pipeline reports an active step; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Pipeline-activity wedge deferral"
...
state/               runtime records and signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .churn-since-* .paused-* .wedge-escalations-* .progress-* .writing-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
