...
state/               runtime records and signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .paused-* .wedge-escalations-* .writing-* .endpoint-gone-* .watch-poll-seq .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
