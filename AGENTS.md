...
At PR ready, verify the author-controlled title and body against the propagated preferences and have mismatches corrected before presenting the PR, while preserving delivery-mode-owned content such as the no-mistakes `## Pipeline` section and its signature.
