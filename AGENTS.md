...
state/               runtime records and signals; gitignored
  ...
  .supervision-host*  supervision host process record, engine conversation, current turn scope and report receipts, and bounded per-turn log; bin/fm-supervision-host.sh owns them; never touch
