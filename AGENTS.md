...
3. **Never tear down unlanded work.**
   ...
   Scout scratch disposal follows that guard; [`docs/configuration.md`](docs/configuration.md#runtime-backend-configbackend--fm_backend) owns its reportless recovery exceptions.
