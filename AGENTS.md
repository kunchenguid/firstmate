...
- `plotting-review` - load for an explicit plotting architecture review or audit, or an investigation where plotting ownership and compatibility are central, but not for ordinary feature work that merely draws a chart.
