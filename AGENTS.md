...
state/               runtime records and signals; gitignored
  ...
  when/              private condition->action watch specs, their trust bindings, single-fire markers, and a repeat watch's bounded fire journal; written only by bin/fm-procevent-when.sh (section 13's process-event-sources trigger)
