...
config/calm-scene  optional Calm working picture, `candles` or the default boat; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
