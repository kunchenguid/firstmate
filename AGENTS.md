...
config/ship-branch-ticket-case  optional presence flag canonicalizing a Jira-style ticket in a ship branch name to uppercase KEY-NNN; LOCAL, gitignored, and not inherited; see docs/configuration.md "Ship branch ticket case"
