...
- `apple-notes-channel` - load on an authenticated `apple-notes-channel: ...` check notification and before projecting an accepted Notes-origin acknowledgment or outcome.
