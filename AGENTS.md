...
state/               runtime records and signals; gitignored
  ...
  lavish-dock.check.sh  generated Lavish dock-reply shim and its .check-trust binding; automatically armed by mutable primary-home bootstrap; report record .lavish-dock-check and prompt-occurrence cursor .lavish-dock-seen (docs/configuration.md "Lavish dock replies")
