...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, and `grok`, plus `kimi` for crewmate and scout dispatch only; never dispatch outside a verified adapter scope.
