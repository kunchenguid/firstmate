...
- `fleet-cleanup` - load before a cleanup pass over several finished tasks, when the captain asks to clean up or clear the fleet, and before tearing down a task whose record you have not classified.
