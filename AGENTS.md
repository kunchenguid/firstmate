...
config/contributions-poll-disabled  optional presence flag durably opting this home out of contribution observation polling and auto-arm; LOCAL, gitignored, written only by bin/fm-contributions.sh disable/enable, and not inherited; see docs/configuration.md "Contribution poll opt-out"
