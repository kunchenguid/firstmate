...
config/remote-herdr-session  optional default Herdr session persisted when this home seeds a remote secondmate route; absent = `fm-remote`; LOCAL, gitignored, and not inherited; see docs/configuration.md "Remote Herdr session"
