...
config/standing-skills  optional skill names, one per line, that every ship and scout brief tells the worker to load first with its harness's own invocation; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Standing skills"
