...
config/context-briefs.conf  which repositories belong to which context brief; LOCAL, gitignored, hand-edited, and not inherited; a repository on no line is reported rather than dropped; see docs/configuration.md "Context briefs"
...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  briefs/<context>.md  the captain's per-context reading surface; LOCAL, gitignored; its narrative and pointers are hand-written and never touched by a tool, while its "Waiting on you" and "Running now" sections are regenerated between markers by bin/fm-context-briefs.sh at the lifecycle moments their records change (docs/configuration.md "Context briefs")
