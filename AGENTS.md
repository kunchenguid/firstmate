...
config/supervision-branch-model  Pi supervision-branch model pin written by /supervision-model; LOCAL, gitignored, and not inherited; absent = the branch uses the same model as main; see docs/configuration.md "Pi supervision branch model"
