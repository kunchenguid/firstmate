...
state/               runtime records and signals; gitignored
  ...
  <id>.nm-state       snapshot of the last no-mistakes pipeline-state projection this task's deterministic watch has seen; bin/fm-nm-state-condition.sh owns the format, fm-spawn.sh arms the watch, fm-teardown.sh removes it (docs/configuration.md "Pipeline-state watch")
