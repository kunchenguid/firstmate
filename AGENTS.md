...
Before publishing a PR or issue description yourself, run `bin/fm-voice-check.sh` on its text and publish only on exit 0 (contract: `docs/configuration.md` "Pre-publication voice check").
