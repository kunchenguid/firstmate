...
A checks-passed result the run's own evidence does not record is reported as blocked rather than done, because a head no check examined is unverified rather than green; treat it as work needing attention, never as a PR ready for review.
