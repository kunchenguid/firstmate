...
config/crew-claude-agent  optional Claude agent profile for crewmate and scout launches; LOCAL, gitignored; absent = today's default profile, and secondmate launches never use it. Inherited by secondmate homes (section 4)
