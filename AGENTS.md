...
config/composer-commands  optional presence flag enabling default-off delivery of an exact allowlisted slash-command captain note (bin/fm-inbox.sh) as keystrokes into this home's own primary session; LOCAL, gitignored, and not inherited; see docs/configuration.md "Composer command delivery"
