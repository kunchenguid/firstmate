...
It performs guarded fast-forward updates of firstmate and registered secondmate homes, refreshes instructions - restarting a second mate whose own instructions changed, after that mate has written its open work down - and never touches anything under `projects/`.
