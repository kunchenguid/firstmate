...
config/herdr-crew-placement  optional "pane" selection placing a Herdr crewmate or scout as a pane split inside the launching agent's own tab instead of the default "tab" topology; LOCAL, gitignored; inherited by secondmate homes; see docs/herdr-backend.md "Crew placement"
