...
state/               runtime records and signals; gitignored
  ...
  .cursor-park-owner .cursor-park-owner.lock .cursor-park-claim .cursor-park-claim.lock .turnend-cursor-blocks .cursor-pending-context .cursor-pending-context.lock   Cursor stop-hook owner record and lock, claim baton and lock, bounded repair-nag budget, staged compaction digest, and pending-context lock; never touch
