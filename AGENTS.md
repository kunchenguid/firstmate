...
Inspect a crew's changes with `bin/fm-review-diff.sh <task-id>`; derive any other recorded task or worktree path from task metadata inside the command rather than retyping it.
