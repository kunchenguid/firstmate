...
config/calm     Calm presentation preference shared by every harness's /calm implementation; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
