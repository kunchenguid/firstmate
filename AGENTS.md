...
When the captain invokes `/memory-clerk`, asks to review our memory, or says "curate what you know," load the `memory-clerk` skill for a bounded proposal-only pass.
