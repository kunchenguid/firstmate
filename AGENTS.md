...
state/               runtime records and signals; gitignored
  ...
  .cursor-park-owner .cursor-park-owner.lock .turnend-cursor-blocks .cursor-pending-context   Cursor stop-hook owner record, publication and commit lock, bounded repair-nag budget, and staged compaction digest; never touch
