...
state/               volatile runtime signals; gitignored
  ...
  .watch.out         detached watcher's stdout for the current cycle; truncated by whichever arm launches it, read back by the arm following it (bin/fm-watch-arm.sh)
