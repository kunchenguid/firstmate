...
The spawn must resolve a genuine isolated task worktree of the project's own repository, distinct from the primary checkout; a failed isolation assertion stops the task.
