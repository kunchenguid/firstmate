...
state/               runtime records and signals; gitignored
  ...
  reconcile-requests/ private open obligations to re-check a captain call whose answer was `reconcile`; written only by bin/fm-captain-hold.sh, retired only by its verify-then-decide outcomes (section 13; docs/captain-hold-lifecycle.md)
