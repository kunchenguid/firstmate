...
Ship shared tracked changes through this repo's direct-PR path, with focused verification, `bin/fm-lint.sh`, one bounded exact-head review, CI, and explicit captain merge approval as owned by `CONTRIBUTING.md`.
