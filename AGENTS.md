...
state/               runtime records and signals; gitignored
  ...
  <id>.pr-refresh-state  private prepared/dispatched/resolved receipt for branch-currency work on an open PR; bin/fm-watch.sh owns its lifecycle
