...
config/escalation-alert  optional away-mode escalation-alert directives, same syntax as config/wedge-alarm but fires on every successfully delivered real escalation rather than only on an injection wedge; LOCAL, gitignored; absent means off; see docs/wedge-alarm.md
