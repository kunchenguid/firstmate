...
- `workspace-steward` - load before inventorying or mutating Herdr workspace, pane, or tab state, or diagnosing SSH/Tailscale connectivity and remote-connection health across the primary server and Pop!_OS.
