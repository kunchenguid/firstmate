...
.tasks.toml          optional per-home tasks-axi config for the default backlog backend; LOCAL, gitignored (section 10)
...
The configured `tasks-axi` backend is the durable queue; the default is `data/backlog.md`.
