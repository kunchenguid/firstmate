...
config/captain-style.json  optional compact captain-style preferences (language, response_tone) set via /helm; LOCAL, gitignored, and not inherited; canonical source for those two axes over data/captain.md prose (section 6); see docs/configuration.md "Captain style preferences"
