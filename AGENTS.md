...
Load the `harness-adapters` [model and effort reference](.agents/skills/harness-adapters/references/common/model-and-effort.md) before choosing effort; it owns the generic fallback and its precedence.
