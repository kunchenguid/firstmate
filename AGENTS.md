...
- `lavish` - load before creating or opening a firstmate-owned interactive review artifact other than the Bearings board; investigating scouts follow section 7's worker-owned visual-review path instead.
