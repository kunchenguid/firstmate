...
config/project-memory  optional per-project memory-folder pointers for worker briefs and Claude auto-memory; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Project memory folders"
