...
config/ssh-launch-stagger-host  optional one-line remote_host value whose repeat same-batch bootstrap SSH launches are spaced out; LOCAL, gitignored, and not inherited; absent means no staggering; see docs/configuration.md "SSH launch stagger host"
