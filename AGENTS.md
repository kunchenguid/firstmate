...
state/               runtime records and signals; gitignored
  ...
  <id>.herdr-launch  plain-Pi structural-launch receipt and recovery binding retained until the exact endpoint and backlog commit or mode-safe cleanup is proven; see docs/herdr-backend.md "Plain-Pi structural launch"
  <id>.herdr-lease  exact plain-Pi Treehouse lease transaction, from holder intent through acquired, cleanup, and confirmed return; owned by fm_treehouse_lease_transaction_* in bin/fm-wake-lib.sh
