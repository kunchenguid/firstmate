...
state/               runtime records and signals; gitignored
  ...
  .hash-* .count-* .stale-* .stale-since-* .churn-since-* .paused-* .wedge-escalations-* .writing-* .agentgone-* .seen-* .hb-surfaced-* .last-* .heartbeat-streak   watcher internals; never touch
