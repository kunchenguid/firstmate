...
config/github-hosts  optional additional GitHub Enterprise hostnames accepted by PR parsing, polling, and merge mechanics; LOCAL, gitignored; see docs/configuration.md "GitHub Enterprise hosts"
