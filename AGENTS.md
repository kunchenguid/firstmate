...
config/nm-review-pane  optional "off" opt-out from the default-on live no-mistakes review pane that Herdr no-mistakes ship tasks get to the right of their worker pane; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "No-mistakes review pane" and docs/herdr-backend.md "No-mistakes review pane"
