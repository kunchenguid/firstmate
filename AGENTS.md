...
config/crew-dispatch.json  optional crewmate dispatch profiles; LOCAL, gitignored; firstmate-maintained but human-editable natural-language rules that choose a per-task profile (section 4; schema owner: docs/configuration.md). Inherited by secondmate homes
