...
Whenever work is under way, the local business-agenda check is installed, or Relay is active, keep exactly one live supervision cycle using the emitted protocol for this primary harness.
