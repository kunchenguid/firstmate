...
The verified primary harnesses are `claude`, `codex`, `opencode`, `pi`, and `grok`; `cursor` is verified only for crewmate and scout dispatch, never as a primary or secondmate harness.
