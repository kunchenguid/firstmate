...
config/calm     Calm presentation preference shared by the Pi extension, the OMP extension, and the Claude Code mod; LOCAL, gitignored, and not inherited; see docs/configuration.md "Calm preference"
