...
A worker names each deferred follow-up in the optional `; follow-ups: <items>` clause of its otherwise unchanged terminal `done:` line, and firstmate queues the real ones through the ordinary completion backlog update in section 10.
