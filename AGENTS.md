...
config/cockpit-observation  optional presence flag enabling the default-off redacted Cockpit observation for this home; LOCAL, gitignored, and not inherited; see docs/configuration.md "Cockpit observation"
