...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .claude-autoarm-failure-count .claude-autoarm-failure-capped .turnend-claude-blocks .turnend-claude-blocks.lock   Claude Stop auto-arm single-flight, epoch, failure-episode, attended-alarm, session-scoped consecutive-failed-re-arm count, durable session-keyed at-the-cap stop record (deleting it silently un-caps an episode the layer deliberately stopped), guard-budget, and budget-lock records; never touch
