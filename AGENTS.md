...
state/               runtime records and signals; gitignored
  ...
  <id>.herdr-create-attempt  exact unpublished Herdr tab/pane identity for a create that is not yet proved; bin/backends/herdr.sh owns the format and exact-id cleanup
