...
config/context-restart-budget     primary-authoritative per-home conversation threshold; LOCAL, gitignored, materialized as 400,000 tokens by locked primary bootstrap and inherited into secondmate homes; see docs/configuration.md "Context restart budget"
...
state/               runtime records and signals; gitignored
  ...
  .context-restart-crossing .context-restart-crossing.lock  Claude's versioned threshold-crossing/ready sentinel and single-flight publication lock; owned by bin/fm-context-restart-lib.sh and never touch
