...
state/               runtime records and signals; gitignored
  ...
  <id>.meta          task metadata whose producer script header owns its exact fields and mutation contract, including profile_delivery=fm-spawn.v1 with delivered_model= and delivered_effort= after a verified launch profile, with docs/configuration.md routing operator-facing backend and trace-context details
