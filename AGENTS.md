...
config/observability  optional presence flag for best-effort local task metric collection during teardown; LOCAL, gitignored; see docs/configuration.md "Local task observability"
...
state/               volatile runtime signals; gitignored
  ...
  <id>.meta          runtime task record; `docs/configuration.md` "Operational home layout and state" points to each producing script that owns its exact base, backend, PR, and X-linked fields
