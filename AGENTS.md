...
config/holusight.json             Optional default-on Holusight startup-evidence settings and per-project enablement; LOCAL, gitignored, inherited by secondmate homes; see docs/configuration.md "Holusight startup evidence"
