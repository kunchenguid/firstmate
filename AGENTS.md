...
config/claude-profiles.json  optional named Claude account-store references for per-assignment quota selection and durable account binding; LOCAL, gitignored, inherited by secondmate homes, and never contains or copies credentials; see docs/configuration.md "Claude account profiles"
