...
state/               runtime records and signals; gitignored
  ...
  .progress-<id>     display-only progress observation record (phase, per-phase seconds, last applied label suffix) advanced by the watcher tick and the fleet snapshot, retired by teardown, safe to delete; bin/fm-progress-lib.sh owns it
