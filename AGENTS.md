...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .turnend-claude-blocks .turnend-claude-containment   Claude Stop auto-arm single-flight, epoch, guard-budget, and once-per-episode containment-notice records; never touch
