...
- `playstudio-agent-loop` - load before driving PlayStudio workspace agent turns without manual UI typing, running the blackjack multi-turn fixture, or calling entry-shell / runs BFF verbs from a mate session.
