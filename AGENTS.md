...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-rewake-turn .claude-rewake-boundary .claude-rewake-boundary.lock .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock   Claude Stop auto-arm single-flight, epoch, active-rewake-turn, turn-boundary generation and lock, failure-episode, attended-alarm, guard-budget, and budget-lock records; never touch
