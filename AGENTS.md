...
state/               runtime records and signals; gitignored
  ...
  <id>.herdr-presentation  quarantinable attempt and restart-binding journal for Herdr's legacy visual projection, no longer created for new spawns; never task or endpoint authority; see docs/herdr-backend.md "Legacy presentation spaces"
