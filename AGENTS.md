...
config/crew-permission-mode  permission mode for claude launches; LOCAL, gitignored; absent or "auto" = --permission-mode auto, "bypass" restores --dangerously-skip-permissions; claude-only, not inherited into secondmate homes; see docs/configuration.md "Crew permission mode"
