...
Re-evaluate queued work after every teardown, recorded PR-ready handoff, and heartbeat, dispatching items only when dependencies, time gates, and project capacity have cleared.
