...
config/discord-webhook  optional Discord webhook URL for review-ready notifications posted once when bin/fm-pr-check.sh records a task's PR; LOCAL, gitignored, recommended mode 0600, absent means inert, and not inherited by secondmate homes; see docs/configuration.md "Review-ready Discord notifications"
...
state/               runtime records and signals; gitignored
  ...
  <id>.pr-notified  canonical PR identity of the last review-ready notification sent for this task; bin/fm-pr-lib.sh owns the marker format and duplicate suppression, and bin/fm-notify.sh publishes it after a successful Discord post
