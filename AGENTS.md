...
Shared tracked material is `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, `.tasks.toml`, `skills-lock.json`, `.github/workflows/`, `bin/`, `.agents/skills/`, and public `skills/`.
...
.agents/skills/      firstmate-loaded skills, committed; firstmate-authored ones carry metadata.internal=true for installers, vendored third-party ones are listed in skills-lock.json and land as installed
.claude/skills       symlink to .agents/skills for claude compatibility
skills-lock.json     provenance and hash lock for the vendored third-party skills under .agents/skills/, committed
