...
config/worker-running-time  optional presence flag opting this home into the default-off reporting of how long each worker has been running, absent meaning the surface is off; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Worker running time"
