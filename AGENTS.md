...
- `story-sharder` - load during normal Linear-workflow intake when a large or ambiguous initiative needs a Linear-resident SPEC, milestones, dependencies, and worker-ready story breakdown before execution.
