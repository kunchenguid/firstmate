...
config/crew-autocompact-pct  optional claude crewmate/scout auto-compaction threshold (1-99); LOCAL, gitignored; absent = today's default behavior; inherited by secondmate homes; see docs/configuration.md "Crew auto-compaction threshold"
