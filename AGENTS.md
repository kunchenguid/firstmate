...
On a no-mistakes ship, the worker's own review and simplification passes over the change are part of implementing, not an independent reviewer stacked on the path.
