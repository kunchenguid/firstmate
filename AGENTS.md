...
- `compact-report-format` - load before writing an internal report's Definition-of-done content, before reading or relaying a report's findings, and before deciding whether a finding needs the full-detail escape hatch.
