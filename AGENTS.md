...
Hermes is verified only as a primary harness, never as a worker, and its launcher fixes every crewmate and secondmate to Pi on the Herdr runtime backend.
