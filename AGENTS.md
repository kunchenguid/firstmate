...
state/               runtime records and signals; gitignored
  ...
  .cursor-park-owner .cursor-park-owner.lock .turnend-cursor-blocks .cursor-pending-context   Cursor stop-hook park generation baton, its claim lock, the bounded repair-nag budget, and a compaction digest staged for the next turn boundary; never touch
