...
config/forge-hosts  optional allowlist of the GitHub hosts the contribution observer may measure and send authenticated reads to, one DNS host name per line beyond the always-allowed github.com; LOCAL, gitignored, and NOT inherited by secondmate homes; see docs/configuration.md "Measurable forge hosts"
