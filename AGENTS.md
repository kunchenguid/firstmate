...
For a no-mistakes ship, trigger validation on the same worker after its implementation commit, following the trigger procedure owned by `harness-adapters`.
