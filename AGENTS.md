...
Give every ordinary crewmate and scout a human-readable task label and refresh it on meaningful lifecycle phase changes; `bin/fm-spawn.sh --help` and `bin/fm-label.sh --help` own the exact mechanics.
