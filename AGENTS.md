...
state/               runtime records and signals; gitignored
  ...
  .telegram-notifications .telegram-notifications.lock  bounded private per-away-session Telegram event-deduplication journal and its serialization lock; written only by bin/fm-telegram.sh
