...
- `daily-upstream-report` - load on an authenticated `daily-upstream-report <report-id>` check notification before reading, synthesizing, or acknowledging that preserved morning report.
