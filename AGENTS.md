...
Load `automatic-dispatch` before routing any authorized crewmate or scout task through version 2 subscription dispatch.
The routing procedure must preserve existing task authority and never expose credential contents.
...
- `automatic-dispatch` - load before routing an authorized crewmate or scout task through version 2 subscription dispatch.
