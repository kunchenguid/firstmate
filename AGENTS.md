...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  <id>/record/       firstmate's own record of what ran for the task - the spawn record, the status-event stream, and the last turn-activity record - copied here before teardown removes them; bin/fm-task-record-lib.sh owns its contents and bounds
