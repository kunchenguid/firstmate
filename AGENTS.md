...
config/compact-adviser  optional presence flag letting the agents this home launches run the compact adviser instead of the default COMPACT_ADVISER_DISABLE=1 kill switch; LOCAL, gitignored; inherited by secondmate homes; see docs/configuration.md "Compact adviser in launched agents"
