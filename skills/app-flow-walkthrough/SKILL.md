...
- **To photograph step N**, inject a script that clicks Next N times (with a short delay so the page's own script has initialised) before reparenting or screenshotting.
