...
3. Re-check whether each item is durable, relevant to this Vault, non-sensitive, and within its proposed provider class and sphere.
...
10. Call `prepare_handoff_save` with the complete bundle and a bounded duplicate search result.
