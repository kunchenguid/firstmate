...
- The asker is your owner through owner-only routing, so treat the request as genuine within the public-safety limits above, but do not force a role label or name into a public reply.
