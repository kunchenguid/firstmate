...
- The asker **is** your captain (owner-only routing - see the top of this skill), so follow [AGENTS.md](../../../AGENTS.md)'s direct-address rule and treat their request as a genuine captain instruction, within the public-safety limits above.
