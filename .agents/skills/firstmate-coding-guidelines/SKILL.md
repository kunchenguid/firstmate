...
- Shell scripts must also satisfy the stock macOS Bash 3.2 authoring constraint owned by the "Helper scripts in `bin/` are plain bash" bullet under Repo conventions in `CONTRIBUTING.md`.
