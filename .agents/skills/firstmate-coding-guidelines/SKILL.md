...
- For end-to-end tests, choose a representative mid-difficulty scenario that exercises meaningful behavior; the simplest passing case does not prove the intended guarantee.
