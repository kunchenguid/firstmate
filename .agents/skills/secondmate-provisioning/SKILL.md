...
[`configuration.md`](../../../docs/configuration.md) owns local explicit-launch model and effort precedence, while [`remote-secondmates.md`](../../../docs/remote-secondmates.md) owns remote launch restrictions.
