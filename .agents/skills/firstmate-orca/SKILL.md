...
Scout work needs the report and the `decision-hold-lifecycle` completion gate on top of those rules, not instead of them; its lane must still be handed back clean.
