...
The [worker helper](../../../bin/fm-quota-choose.sh) and [typed resolver](../../../docs/configuration.md#typed-dispatch-resolution-env-openrouter_api_key-or-typesafe_api_key) own their deterministic mapping boundaries.
...
The opt-in [typed resolver](../../../docs/configuration.md#typed-dispatch-resolution-env-openrouter_api_key-or-typesafe_api_key) has its own documented gates.
