...
Prime Agent candidates must use the verified `openai-codex/<id>` prefix; bare, `anthropic/`, and other provider prefixes are refused rather than mapped to an unrelated quota family.
