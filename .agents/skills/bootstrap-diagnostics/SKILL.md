...
- `SOT_GAP: <program_id> - sources Done but no standing pointer matching /<needle>/ in captain.md|decisions/` - surface the missing standing pointer to the captain, but do not auto-edit `data/captain.md` or create a decision file.
