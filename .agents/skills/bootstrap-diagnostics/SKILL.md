...
When any diagnostic needs Jay's attention, report the plain consequence and requested action using `AGENTS.md` section 9's captain-facing translation contract; do not name the diagnostic label unless Jay needs to paste it into a command or issue.
