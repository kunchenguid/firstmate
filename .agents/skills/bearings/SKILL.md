...
Schema-less captures are rejected and remain unapplied until the board is rebuilt; the [board-control contract](../../../docs/captain-hold-lifecycle.md#bearings-board-controls) owns this old-board rule.
