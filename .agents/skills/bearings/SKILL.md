---
name: bearings
description: Load for /bearings, catch-up, morning brief, status report, where-I-left-off, or what-is-in-the-works requests, including file and live-PR variants.
user-invocable: true
metadata:
  internal: true
---
