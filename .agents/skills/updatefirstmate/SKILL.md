...
3. **Nudge each updated live secondmate.**
   ...
   ```sh
   FM_HOME=<this-firstmate-home> bin/fm-send.sh <id> --delivery-only 'firstmate was updated to the latest - please re-read your AGENTS.md to pick up the new instructions.'
   ```
