...
3. **Write within the existing boundaries.**
   ...
   - Knowledge general to every Firstmate user belongs in this repo's shared tracked material through the normal branch, PR, required-CI, and captain-approved merge path.
