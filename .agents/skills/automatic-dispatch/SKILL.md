...
7. Build the exact step 2 fields plus `taskId`.
...
11. After re-evaluation, retry one proven transient once; fall back on unavailable quota/authentication/models; stop immediately on unsafe or uncertain writes.
12. Stop when criteria are covered or work is dependent/redundant/quota-bound/host-bound.
