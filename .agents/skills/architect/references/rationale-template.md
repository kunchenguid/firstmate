...
*Things you noticed during the sketch that the supervisor needs to weigh in on, and risks worth flagging before implementation starts. Phrase as questions, not assertions, so the supervisor's answer is the resolution rather than a comment.*
