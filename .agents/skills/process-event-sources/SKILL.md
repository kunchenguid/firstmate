...
- registration and ownership transitions, stop authority, and claim reclamation follow the operating contract in [`docs/configuration.md`](../../../docs/configuration.md#process-to-event-sources-stateprocevent);
