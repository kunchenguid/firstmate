...
Before escalating the refusal as a needed credential, check the [worker launch environment contract](../../../../../docs/configuration.md#worker-launch-environment-configlaunch-env-allowlist-and---env) for a withheld environment grant.
