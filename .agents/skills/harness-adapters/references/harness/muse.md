...
Verified 2026-08-05 on Muse Code 0.1.0-R708.1, build sha 427a430436, with the composer shape re-measured 2026-09-17 on Muse Code 1.3.0.
...
| Composer | Prompt glyph truecolor `38;2;90;160;255`, luminance about 149.9 and narrowly above ghost threshold 128; typed text is `38;2;204;211;219`, about 209.8, with no observed placeholder or ghost. 0.1.0 drew a bordered `⟩`; 1.3.0 draws `❯` between a TITLED opening rule and a solid closing rule, and the shared classifier reads that pair only since the titled-separator repair recorded in `../../../docs/verification/runtime-backends.md`. |
