...
| Skill | `/<skill>`, with end-to-end user-skill discovery and invocation; the popup may consume Enter and fill an argument placeholder, requiring a real second Enter. |
...
Slash autocomplete can turn the first Enter into selection plus an argument hint, including a skill's optional argument or `/compact compaction instructions`, without submission.
