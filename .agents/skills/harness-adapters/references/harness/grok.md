...
| Skill | `/<skill>`, for example `/bearings`, with end-to-end user-skill discovery and invocation; the popup may consume Enter and fill an argument placeholder, requiring a real second Enter. |
...
On 2026-07-03 two Grok 0.2.82 Herdr workers left a skill command typed for minutes while send returned success.
