...
| Marker | See [Detection](#detection) for marker and ancestry ownership. |
...
[`bin/fm-harness.sh`](../../../../../bin/fm-harness.sh) owns OMP marker precedence and ancestry detection; [`bin/fm-session-lock-lib.sh`](../../../../../bin/fm-session-lock-lib.sh) owns the shared Bun-launcher match used for session ownership and liveness.
[OMP verification](../../../../../docs/verification/runtime-backends.md#oh-my-pi-omp) records the native-binary and Bun-launcher shapes and version-scoped marker observations.
