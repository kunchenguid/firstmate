...
The [trust helper's header](../../../../../bin/fm-claude-trust.sh) owns the protected-path refusals and scope requirements that gate Claude launches into worktrees and seeded secondmate homes.
