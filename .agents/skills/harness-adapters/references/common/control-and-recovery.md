...
Pi gates the fresh-worktree case too; like Claude, a task spawn pre-registers trust rather than answering the dialog, and `references/harness/pi.md` owns that recipe and where the decision persists.
