...
For Pi-family managed launches, follow the scoped approval and compatibility contract in [`fm-spawn.sh --help`](../../../../../bin/fm-spawn.sh); [the Pi reference](../harness/pi.md) routes manual primary setup.
