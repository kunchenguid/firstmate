...
Grok avoids its non-project picker by starting in the isolated git root; its separate project-folder trust refusal is owned by `references/harness/grok.md`.
