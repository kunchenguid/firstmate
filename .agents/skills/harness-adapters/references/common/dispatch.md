...
`config/crew-dispatch.json` can override that static default for one crewmate or scout with the concrete profile fields owned by [`docs/configuration.md`](../../../../../docs/configuration.md), including an optional Codex home.
