...
`config/crew-dispatch.json` can override that static default for one crewmate or scout with concrete harness, model, and effort axes, plus a Claude account axis on `claude` profiles.
