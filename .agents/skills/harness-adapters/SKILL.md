...
Firstmate-launched Pi worker isolation is documented under [`docs/configuration.md`](../../../docs/configuration.md#harness-support), while `bin/fm-spawn.sh` owns the exact launch flags and explicit extension paths.
