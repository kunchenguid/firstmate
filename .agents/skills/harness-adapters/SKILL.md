...
| codex | `--model <model>` | `-c 'model_reasoning_effort="<low\|medium\|high\|xhigh\|max>"'` | Verified on codex-cli 0.147.0 (2026-08-12). `codex debug models` reports low/medium/high/xhigh/max for `gpt-5.6-luna`; Firstmate emits `max` only for that verified model and keeps it omitted for other Codex models. |
...
## codex (VERIFIED 2026-08-12, codex-cli 0.147.0)
