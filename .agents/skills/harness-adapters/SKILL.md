...
- pi and pi-signed: `/skill:<name>`, for example `/skill:stow`.
  Pi 0.84.2 documents this exact namespace and its RPC `get_commands` response exposed `skill:stow` from this repo's discovered skill set on 2026-08-22.
