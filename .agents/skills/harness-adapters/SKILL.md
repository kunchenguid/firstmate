...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, and kiro.
...
Muse, Gemini, AGY, and Kiro are verified only for crewmate and scout work, never a secondmate or primary.
...
```json harness-adapter-routing-v1
{
  ...
  "harnesses": {
    ...
    "kiro": "references/harness/kiro.md"
  }
}
```
