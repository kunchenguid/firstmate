...
description: >-
  ...
  Per-harness verified facts live in this skill's own directory (claude.md, codex.md, opencode.md, pi.md, grok.md, cursor.md, kimi.md, muse.md), read only the ones in play, not all of them.
...
Verified facts for each adapter live in its own file in this skill's
directory, not inline here, since a spawn or recovery only ever needs the one
harness actually in play - this repo's own fleet has only ever dispatched on
`claude`. Read the file for the harness at hand:

- `claude.md` - Claude Code (VERIFIED; busy-state hooks live-verified 2026-07-28 on Claude Code 2.1.220)
- `codex.md` - Codex (VERIFIED 2026-06-11, codex-cli 0.139.0)
- `opencode.md` - opencode (VERIFIED 2026-06-11, v1.15.7-1.17.6; 1.18.4 busy-queue re-verified 2026-07-20)
- `pi.md` - pi and pi-signed (VERIFIED 2026-07-27)
- `grok.md` - grok (VERIFIED 2026-06-29, grok 0.2.73; slash-submit re-verified 2026-07-03 on 0.2.82; reasoning-effort ceiling re-verified 2026-07-13 on 0.2.99; exit paths re-verified 2026-07-19 on grok 0.2.103)
- `cursor.md` - cursor (VERIFIED CREWMATE/SCOUT 2026-08-11 on tmux and 2026-08-12 on Herdr, and SECONDMATE/PRIMARY 2026-08-13, Cursor Agent CLI 2026.08.11-e8db854)
- `kimi.md` - kimi (VERIFIED 2026-07-25, kimi 0.29.1)
- `muse.md` - muse (VERIFIED 2026-08-05, Muse Code 0.1.0-R708.1, build sha 427a430436)

Comparing two or more harnesses (e.g. resolving a `quota-array-dispatch`
profile array, or verifying a new adapter against an existing one) needs more
than one of these files read - read exactly the ones in play, not the whole
set on spec.
