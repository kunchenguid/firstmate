...
**Primary-session guard fact (verified 2026-07-08, codex-cli 0.142.1; notification payload and launch override verified 2026-07-14, codex-cli 0.144.4).**
...
For a genuine captain question, run `bin/fm-captain-wait.sh arm <stable-new-id>` before yielding; never arm informational output.
The script's `--help` owns the lifecycle and notifier mechanics.
