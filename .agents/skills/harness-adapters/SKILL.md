...
Before lock recovery it requires the shared primary-home scope, and in away mode it may recover the session lock but leaves watcher supervision with the sub-supervisor.
