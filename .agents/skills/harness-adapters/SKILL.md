...
Muse, Gemini, and AGY are verified only for crewmate and scout work, never a primary; a secondmate on one of them is unverified and starts only where that home's `config/unverified-secondmate-harness` records the captain's acceptance.
