...
omp publishes no marker of its own; `FM_OMP_HARNESS=omp` is Firstmate's launch marker, with anchored process-name ancestry as `references/harness/omp.md` records.
