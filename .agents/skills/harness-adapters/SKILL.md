...
The watcher extension arms an already-owned initial `session_start`, reserves missing/dead lock recovery for `resume`, and starts and verifies every later successor before delivering an ordinary actionable wake.
