...
description: >-
  ...
  Use before spawning or recovering a worker or second mate, handling trust, sending a harness-specific skill invocation, interrupting, exiting, resuming, verifying an adapter, or selecting fallback effort.
