...
The watcher extension performs the initial `session_start` arm and starts and verifies every later successor before delivering an ordinary actionable wake.
