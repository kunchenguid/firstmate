...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, and humanlayer.
...
```json harness-adapter-routing-v1
{
  ...
  "harnesses": {
    ...
    "humanlayer": "references/harness/humanlayer.md"
  }
}
```
