...
The logic-specific mapping is that an authorized implementation may lift the validated reducer, machine, or function set into the real module.
Keep the HTML shell as the re-runnable primary source using the task's authorized delivery path.
