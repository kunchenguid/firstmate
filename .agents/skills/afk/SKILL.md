...
The header of `bin/fm-tmux-lib.sh` owns the harness-gated tmux busy-queued Enter exception used by both this daemon and `fm-send.sh`.
The separate OpenCode gap on Herdr remains documented in `docs/herdr-backend.md`.
