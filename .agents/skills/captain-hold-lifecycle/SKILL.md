...
When the answer changes what a task must build, follow [`task-lifecycle`](../task-lifecycle/SKILL.md)'s No-mistakes validation contract to preserve the captain's words in the brief and steer the worker.
