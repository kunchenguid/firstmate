...
Each module presents exactly one interface to its callers and tests.
...
- **Exploring alternative interfaces** - see [DESIGN-IT-TWICE.md](DESIGN-IT-TWICE.md) for the authorized independent-review pattern, then compare the designs on depth, locality, and seam placement.
