...
1. Run the Comment Sicko reviewer in a separate pass over the scope (see `agents/comment-sicko.md` (vendored at `.agents/skills/no-comments/agents/comment-sicko.md`)). Do not restate its rules.
