...
- The project startup file carries one stable pointer line containing the campaign id and record path; the lead writes it, and it contains no fleet handles.
