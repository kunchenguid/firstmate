...
- **Architectural shape.**
  For example: "We're using a monorepo."
  Another example: "The write model is event-sourced, the read model is projected into Postgres."
...
- **Constraints not visible in the code.**
  For example: "We can't use AWS because of compliance requirements."
  Another example: "Response times must be under 200ms because of the partner API contract."
