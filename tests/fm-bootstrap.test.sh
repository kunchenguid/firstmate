...
antigravity low medium and high efforts are accepted^{"rules":[{"when":"agy low","use":{"harness":"antigravity","model":"gemini-3.8-flash-low","effort":"low"}},{"when":"agy medium","use":{"harness":"antigravity","model":"gemini-3.8-flash-medium","effort":"medium"}},{"when":"agy high","use":{"harness":"antigravity","model":"gemini-3.8-flash-high","effort":"high"}}]}^empty^
unsupported antigravity xhigh effort is flagged^{"rules":[{"when":"agy deep","use":{"harness":"antigravity","model":"gemini-3.8-flash-high","effort":"xhigh"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: antigravity:xhigh
