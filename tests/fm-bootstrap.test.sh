...
make_fake_toolchain() {
  ...
  fm_fake_version_tool "$fakebin" chrome-devtools-axi FM_FAKE_CHROME_DEVTOOLS_AXI_VERSION 0.1.35
...
minimum chrome-devtools-axi version is accepted^0.1.35^empty
newer chrome-devtools-axi patch is accepted^0.1.36^empty
newer chrome-devtools-axi minor is accepted^0.2.0^empty
newer chrome-devtools-axi major is accepted^1.0.0^empty
the patch just below the floor reports an upgrade^0.1.34^missing
