...
gpt-5.6-luna codex max effort is accepted^{"rules":[{"when":"luna work","use":{"harness":"codex","model":"gpt-5.6-luna","effort":"max"}}]}^empty^
unverified codex max effort is flagged^{"rules":[{"when":"other codex work","use":{"harness":"codex","model":"gpt-5","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex:max
...
array profile with gpt-5.6-luna max is accepted^{"rules":[{"when":"luna work","use":[{"harness":"codex","model":"gpt-5.6-luna","effort":"max"},{"harness":"codex","model":"gpt-5.6-luna","effort":"xhigh"},{"harness":"codex","model":"gpt-5.6-luna","effort":"high"},{"harness":"codex","model":"gpt-5.6-luna","effort":"medium"},{"harness":"codex","model":"gpt-5.6-luna","effort":"low"}]}]}^empty^
