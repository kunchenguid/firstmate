...
copilot none effort is accepted^{"rules":[{"when":"light copilot task","use":{"harness":"copilot","model":"gpt-5.3-codex","effort":"none"}}]}^grep^CREW_DISPATCH: active config/crew-dispatch.json
