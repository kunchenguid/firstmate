...
agy model profile is accepted^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini-3.8-flash-low"}}]}^empty^
unsupported agy effort is flagged^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini-3.8-flash-low","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: agy:high
