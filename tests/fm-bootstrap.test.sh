...
unsupported agy max effort is flagged^{"default":{"harness":"agy","model":"agy-model","effort":"max"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: agy:max
