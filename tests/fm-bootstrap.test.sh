...
codex Luna max effort is accepted^{"rules":[{"when":"luna feature","use":{"harness":"codex","model":"gpt-5.6-luna","effort":"max"}}]}^empty^
codex Sol max effort is accepted^{"rules":[{"when":"sol feature","use":{"harness":"codex","model":"gpt-5.6-sol","effort":"max"}}]}^empty^
unsupported codex Spark max effort is flagged^{"rules":[{"when":"spark feature","use":{"harness":"codex","model":"gpt-5.3-codex-spark","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex:max
unknown codex max effort is flagged^{"rules":[{"when":"future feature","use":{"harness":"codex","model":"future-model","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex:max
