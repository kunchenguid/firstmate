...
agy low effort is accepted^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini/test","effort":"low"}}]}^empty^
agy medium effort is accepted^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini/test","effort":"medium"}}]}^empty^
agy high effort is accepted^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini/test","effort":"high"}}]}^empty^
unsupported agy effort is flagged^{"rules":[{"when":"agy work","use":{"harness":"agy","model":"gemini/test","effort":"max"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: agy:max
