...
array profile codex ultra effort is flagged^{"rules":[{"when":"big feature","use":[{"harness":"codex","effort":"ultra"}]}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex:ultra
ROWS
