...
test_spawn_secondmate_harness_model_token() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '$w/home/state/sm.claude-settings.json' --model 'opus'" \
...
test_spawn_secondmate_harness_model_and_effort_tokens() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '$w/home/state/sm.claude-settings.json' --model 'opus' --effort 'high'" \
...
test_spawn_secondmate_claude_permission_mode_auto() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --permission-mode auto --settings '$w/home/state/sm.claude-settings.json' --model 'opus'" \
