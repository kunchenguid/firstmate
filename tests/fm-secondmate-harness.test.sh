...
SH
  ...
  [ "$got" = pi-signed ] || fail "exact signed wrapper ancestry resolved '$got', expected pi-signed"
  ...
  pass "pi-signed identity: exact ancestry wins over Pi's shared marker without broad process matching"
}
