...
test_backend_name_precedence() {
  ...
  [ "$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier; PATH="$FAKE_NONDARWIN_BIN:$PATH" FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name)" = tmux ] \
    || fail "fm_backend_name should default to tmux with no env/config/detection markers"

  printf 'tmux\n' > "$cfg/backend"
  [ "$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name)" = tmux ] \
    || fail "fm_backend_name should read config/backend"

  [ "$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; FM_BACKEND=tmux FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name)" = tmux ] \
...
test_backend_detect_precedence() {
  ...
  if out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier; PATH="$FAKE_NONDARWIN_BIN:$PATH" fm_backend_detect); then
    fail "fm_backend_detect should return 1 (undetected) with no markers set, got '$out'"
  fi

  out=$(unset TMUX PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; HERDR_ENV=1 fm_backend_detect) \
  ...
  out=$(unset HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; TMUX='fake,1,0' fm_backend_detect) \
  ...
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD; CMUX_WORKSPACE_ID='fake-uuid' fm_backend_detect) \
  ...
  out=$(unset TMUX HERDR_ENV CMUX_WORKSPACE_ID; PASEO_AGENT_ID='agent-1' fm_backend_detect) \
    || fail "fm_backend_detect should succeed when PASEO_AGENT_ID is set"
  [ "$out" = paseo ] || fail "fm_backend_detect should report paseo for PASEO_AGENT_ID alone, got '$out'"
  ...
  out=$(unset CMUX_WORKSPACE_ID PASEO_AGENT_ID PASEO_AGENT_CWD; TMUX='fake,1,0' HERDR_ENV=1 fm_backend_detect) \
  ...
  out=$(unset HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD; TMUX='fake,1,0' CMUX_WORKSPACE_ID='fake-uuid' fm_backend_detect) \
  ...
  out=$(unset TMUX PASEO_AGENT_ID PASEO_AGENT_CWD; HERDR_ENV=1 CMUX_WORKSPACE_ID='fake-uuid' fm_backend_detect) \
  ...
  out=$(unset PASEO_AGENT_ID PASEO_AGENT_CWD; TMUX='fake,1,0' HERDR_ENV=1 CMUX_WORKSPACE_ID='fake-uuid' fm_backend_detect) \
...
test_backend_detect_cmux_fallback_bundle_id() {
  ...
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$fb:$PATH" __CFBundleIdentifier='com.cmuxterm.app' fm_backend_detect) \
  ...
  (
    unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID
  ...
  if out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$fb:$PATH" FM_FAKE_PS_TABLE="$dir/no-table" __CFBundleIdentifier='com.apple.Terminal' fm_backend_detect); then
...
test_backend_detect_cmux_fallback_requires_darwin() {
  local out
  if out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$FAKE_NONDARWIN_BIN:$PATH" __CFBundleIdentifier='com.cmuxterm.app' fm_backend_detect); then
...
test_backend_detect_cmux_fallback_tmux_nested_false_positive() {
  ...
  out=$(unset HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$fb:$PATH" TMUX='fake,1,0' __CFBundleIdentifier='com.cmuxterm.app' fm_backend_detect) \
  ...
  out=$(unset TMUX PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$fb:$PATH" HERDR_ENV=1 __CFBundleIdentifier='com.cmuxterm.app' fm_backend_detect) \
...
test_backend_detect_cmux_fallback_ancestry_pid_match() {
  ...
  (
    unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier
...
test_backend_detect_cmux_fallback_ancestry_comm_match() {
  ...
  (
    unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier FM_FAKE_LSAPPINFO_OUT
...
test_backend_detect_cmux_fallback_ancestry_stops_at_launchd() {
  ...
  if out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier FM_FAKE_LSAPPINFO_OUT; PATH="$fb:$PATH" FM_FAKE_PS_TABLE="$table" fm_backend_detect); then
...
test_backend_name_cmux_fallback_notice() {
  ...
  : > "$errfile"
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; PATH="$fb:$PATH" __CFBundleIdentifier='com.cmuxterm.app' FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name 2>"$errfile")
  ...
  : > "$errfile"
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD; CMUX_WORKSPACE_ID='fake-uuid' FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name 2>"$errfile")
...
test_backend_name_autodetect_notice() {
  ...
  : > "$errfile"
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID __CFBundleIdentifier; PATH="$FAKE_NONDARWIN_BIN:$PATH" FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name 2>"$errfile")
  ...
  : > "$errfile"
  out=$(unset TMUX CMUX_WORKSPACE_ID PASEO_AGENT_ID PASEO_AGENT_CWD; HERDR_ENV=1 FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name 2>"$errfile")
  ...
  : > "$errfile"
  out=$(unset HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD CMUX_WORKSPACE_ID; TMUX='fake,1,0' FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name 2>"$errfile")
...
test_backend_name_explicit_beats_detection() {
  ...
  out=$(unset TMUX PASEO_AGENT_ID PASEO_AGENT_CWD; HERDR_ENV=1 FM_BACKEND=tmux FM_BACKEND_CONFIG_DIR="$dir/config-empty" fm_backend_name)
  [ "$out" = tmux ] || fail "FM_BACKEND=tmux should win over an ambient HERDR_ENV=1 auto-detect marker, got '$out'"

  out=$(unset TMUX PASEO_AGENT_ID PASEO_AGENT_CWD; HERDR_ENV=1 FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name)
  ...
  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD; CMUX_WORKSPACE_ID='fake-uuid' FM_BACKEND=tmux FM_BACKEND_CONFIG_DIR="$dir/config-empty" fm_backend_name)
  [ "$out" = tmux ] || fail "FM_BACKEND=tmux should win over an ambient CMUX_WORKSPACE_ID auto-detect marker, got '$out'"

  out=$(unset TMUX HERDR_ENV PASEO_AGENT_ID PASEO_AGENT_CWD; CMUX_WORKSPACE_ID='fake-uuid' FM_BACKEND='' FM_BACKEND_CONFIG_DIR="$cfg" fm_backend_name)
