...
# fm-operational-input.sh: sourced by fm-marker-lib.sh since #909; a BASE_REF at or after
# that commit needs the sibling in the synthetic old bin/ or old fm-send aborts on source.
