...
test_claude_prompt_suggestion_split_by_kind() {
  ...
  expected="claude --dangerously-skip-permissions --name 'SM Suggestion Secondmate Z18' \"\$('${ROOT}/bin/fm-operational-input.sh' encode launch-brief < '$sm/data/charter.md')\""
  case "$launch" in
    *"$expected") ;;
