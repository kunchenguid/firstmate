...
#   - context-aware next-step guidance for read-only, AFK, X/portal modes, and normal
#     watcher ownership
...
EOF
  ...
  # gh-axi is absent from the minimal system BASE_PATH on every supported host,
  # unlike node which some distributions now install under /usr/bin.
  rm -f "$fakebin/gh-axi"
