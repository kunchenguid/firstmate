...
EOF
  ...
  # fm-wake-drain.sh's real timestamped reason presentation.
  assert_contains "$out" "— needs-decision: pick a library" "fm-wake-drain.sh's real drained reason did not appear"
