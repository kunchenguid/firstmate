...
test_invalid_entrypoints_have_zero_side_effects() {
  ...
  for value in "${INVALID_URLS[@]}"; do
    ...
    case "$(cat "$dir/stderr")" in
      'error: invalid PR merge request'|error:\ PR\ URL\ must\ match\ https://github.com/*) ;;
      *) fail "merge invalid URL diagnostic was neither generic nor the canonical provider-shape refusal" ;;
    esac
    after=$(state_snapshot "$dir/home/state")
