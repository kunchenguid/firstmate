...
new_window devin "$LAB/bin/devin" 900
wait_for_state "$SESSION:devin" alive \
  || fail "a running Devin foreground process must classify alive"
pass "tmux liveness: a Devin foreground process classifies alive"
