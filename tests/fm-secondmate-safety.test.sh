...
test_fm_home_parameterization() {
  ...
  [ "$out" = "fast-preview off" ] || fail "fm-project-mode did not isolate missing registry by home"
...
test_home_seed_refuses_local_only_project() {
  ...
  grep -F 'project alpha is local-only; secondmate routes support only fast-preview, no-mistakes, and direct-PR projects' "$err" >/dev/null \
