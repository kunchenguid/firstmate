...
#     crewmate into the "fm" workspace
...
# --- 1. primary-shaped home: a crewmate spawns into the "fm" space ----------
...
[ "$CM1_WS_LABEL" = "fm" ] || fail "a primary-shaped home's crewmate should land in the 'fm' workspace, got '$CM1_WS_LABEL'"
pass "real herdr E2E: the primary-shaped home's crewmate landed in the 'fm' workspace"
