...
# versioned install tree. The real installer links both ~/.local/bin/cursor-agent
# and ~/.local/bin/agent to <root>/versions/<version>/cursor-agent.
