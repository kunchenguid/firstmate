...
SH
  ...
  fm_test_write_active_treehouse_fake "$fakebin" "$case_dir/wt"
...
# Teardown against the fixture's clean, origin-backed worktree. The fork's
# occupancy guard requires the same real lease identity that production records,
# while these cases remain focused on the backlog transition.
