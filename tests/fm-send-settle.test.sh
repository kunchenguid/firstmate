...
# sleeping.
# Pane reads return an empty bordered composer, so the Herdr composer classifier
# observes that the first Enter submitted successfully.
# The sleep log path comes from
# FM_SLEEP_LOG.
