...
# The shared `ACCESS_GATE` text those sections interpolate sidesteps the class a
# second way, by being a plain double-quoted string rather than a heredoc at all.
