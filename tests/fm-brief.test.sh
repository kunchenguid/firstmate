...
test_faster_paths_use_configured_authority_without_stacked_review() {
  ...
  brief="$home/data/$id/brief.md"
  assert_grep "The configured merge authority approves the ready branch, then the main Firstmate merges it into local \`main\` through the guarded fast-forward path; a second mate and its workers never land their own result." "$brief" \
