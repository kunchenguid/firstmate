...
test_matrix_herdr_halfblock_rule_bounds_bare_wrap() {
  ...
  local screen plain out
  # Keep the measured UTF-8 bytes literal. macOS's Bash 3.2 does not expand
  # \u escapes in either ANSI-C strings or printf, which would otherwise turn
  # this into a test of the ASCII text "\u2580" rather than the rendered edge.
