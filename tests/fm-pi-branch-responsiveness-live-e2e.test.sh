...
for lib in fm-async-exec fm-branch-dispatch fm-branch-model-picker fm-calm-branch-outcomes fm-calm-visibility fm-native-contract fm-operational-input; do
