...
for lib in fm-async-exec fm-branch-dispatch fm-branch-model-picker fm-calm-visibility fm-calm-visibility-core fm-native-contract fm-operational-input; do
