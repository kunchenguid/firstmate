...
run_native_ahoy_regressions() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-context-handoff.ts" \
    "$ROOT/.pi/extensions/lib/fm-operational-input.ts" "$AHOY_PROJECT/.pi/extensions/lib/"
  cp \
...
cp "$ROOT/.pi/extensions/lib/fm-context-handoff.ts" "$PROJECT/.pi/extensions/lib/fm-context-handoff.ts"
