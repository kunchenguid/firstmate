...
cp "$ROOT/.pi/extensions/lib/fm-calm-working-spaceship.ts" "$TMP_ROOT/lib/fm-calm-working-spaceship.ts"
cp "$ROOT/.pi/extensions/lib/fm-calm-working-spaceship-sprite.ts" "$TMP_ROOT/lib/fm-calm-working-spaceship-sprite.ts"
