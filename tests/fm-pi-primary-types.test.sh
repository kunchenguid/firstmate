...
cp "$ROOT/.pi/extensions/lib/fm-extension-env.ts" "$TMP_ROOT/lib/fm-extension-env.ts"
cp "$ROOT/.pi/extensions/lib/fm-followup-delivery.ts" "$TMP_ROOT/lib/fm-followup-delivery.ts"
