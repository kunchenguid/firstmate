...
cp "$ROOT/.pi/extensions/fm-tasks.ts" "$TMP_ROOT/fm-tasks.ts"
...
cp "$ROOT/.pi/extensions/fm-task-card-footer.ts" "$TMP_ROOT/fm-task-card-footer.ts"
cp "$ROOT/.pi/extensions/lib/fm-task-card-footer.ts" "$TMP_ROOT/lib/fm-task-card-footer.ts"
cp "$ROOT/.pi/extensions/lib/fm-task-card-footer-state.ts" "$TMP_ROOT/lib/fm-task-card-footer-state.ts"
