...
cp "$ROOT/.pi/extensions/fm-0-pi-cursor-sdk-integration.ts" "$TMP_ROOT/fm-0-pi-cursor-sdk-integration.ts"
...
cp "$ROOT/.pi/extensions/fm-treehouse-trust.ts" "$TMP_ROOT/fm-treehouse-trust.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-branch-cursor-sdk-loader.ts" "$TMP_ROOT/lib/fm-branch-cursor-sdk-loader.ts"
cp "$ROOT/.pi/extensions/lib/fm-pi-cursor-calm-assistant-layout.ts" "$TMP_ROOT/lib/fm-pi-cursor-calm-assistant-layout.ts"
cp "$ROOT/.pi/extensions/lib/fm-pi-cursor-calm-operational-user-layout.ts" "$TMP_ROOT/lib/fm-pi-cursor-calm-operational-user-layout.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-primary-stuck-primary.ts" "$TMP_ROOT/lib/fm-primary-stuck-primary.ts"
cp "$ROOT/.pi/extensions/lib/fm-cursor-replay-execute.ts" "$TMP_ROOT/lib/fm-cursor-replay-execute.ts"
