...
cp "$ROOT/.pi/extensions/fm-captains-call-shortcut.ts" "$TMP_ROOT/fm-captains-call-shortcut.ts" || exit 1
...
cp "$ROOT/.pi/extensions/lib/fm-calm-compatibility.ts" "$TMP_ROOT/lib/fm-calm-compatibility.ts"
