...
cp "$ROOT/.pi/extensions/fm-pi-quota-status.ts" "$TMP_ROOT/fm-pi-quota-status.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-pi-quota-status.ts" "$TMP_ROOT/lib/fm-pi-quota-status.ts"
