...
#
# bin/fm-plainenglish-hook.sh is guarded for the other reason: it delivers its
# whole payload as hook stdout, which Grok discards from model context
# (docs/sessionstart-nudge.md "Harness transports"), so running it under Grok
# could only spend a process to produce nothing.
