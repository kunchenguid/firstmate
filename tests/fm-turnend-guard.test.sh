...
install_guard_scripts() {
  ...
  cp "$ROOT/bin/fm-corr-abgleich.sh" "$dir/bin/fm-corr-abgleich.sh"
  cp "$ROOT/bin/fm-pending-reply-lib.sh" "$dir/bin/fm-pending-reply-lib.sh"
  cp "$ROOT/bin/fm-marker-lib.sh" "$dir/bin/fm-marker-lib.sh"
  cp "$ROOT/bin/fm-backend.sh" "$dir/bin/fm-backend.sh"
  cp "$ROOT/bin/fm-proctree-lib.sh" "$dir/bin/fm-proctree-lib.sh"
  cp "$ROOT/bin/fm-tmux-lib.sh" "$dir/bin/fm-tmux-lib.sh"
  ...
  cp "$ROOT/bin/fm-nm-run-lib.sh" "$dir/bin/fm-nm-run-lib.sh"
...
test_tracked_claude_entries_inert_under_grok() {
  ...
  for script in fm-turnend-guard.sh fm-claude-stop-autoarm.sh fm-sessionstart-run.sh \
    ...
    fm-prompt-regeln.sh fm-git-guard.sh fm-kill-pretool-check.sh; do
