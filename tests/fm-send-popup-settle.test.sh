...
# Plain text to traex likewise rides the inbox; only harness-native invocations
# use the typed plane and its popup settle.
rides_inbox 'traex plain text' traex 'just a normal steer'
