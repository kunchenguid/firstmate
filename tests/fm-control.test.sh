...
VERIFIED_HARNESSES="claude codex copilot opencode pi pi-signed grok kimi cursor muse"
...
test_harness_kind_capability() {
  ...
  for harness in claude codex copilot opencode pi pi-signed grok kimi cursor; do
