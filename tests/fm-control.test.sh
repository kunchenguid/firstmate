...
VERIFIED_HARNESSES="claude codex opencode omp pi pi-signed grok kimi cursor muse"
...
test_harness_kind_capability() {
  ...
  for harness in claude codex opencode omp pi pi-signed grok kimi cursor; do
