...
[ "$(fm_pane_stop gemini 'Error: Quota reached. Please wait 1s')" = $'quota-exhausted\tgemini\t1\t1s' ] || fail 'seconds reset'
...
DIALOGS
pass 'quota stops and documented startup dialogs match conservatively with parsed reset delays'
