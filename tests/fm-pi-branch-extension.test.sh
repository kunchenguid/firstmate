...
install_pi_branch_extension_fixture() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-calm-visibility-core.ts" "$repo/.pi/extensions/lib/fm-calm-visibility-core.ts"
...
test_outcomes_tool_uses_stock_execution_and_export_consumers() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-calm-visibility-core.ts" "$fixture/.pi/extensions/lib/fm-calm-visibility-core.ts"
