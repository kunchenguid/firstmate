...
test_tmux_agent_state_classifies() {
  ...
  for harness in claude codex opencode grok kimi traex pi pi-signed pi-launcher Pi; do
  ...
  # coco pane as a live traex agent and suppress a needed respawn. The classifier
  # matches traex EXACTLY, so every coco name must stay out of `alive`.
