...
CALM_PREFERENCE="$ROOT/.pi/extensions/lib/fm-calm-preference.ts"
...
test_home_resolution() {
  ...
  cp "$CALM_PREFERENCE" "$fixture/project/.pi/extensions/lib/fm-calm-preference.ts"
...
test_rendering_and_session_lifecycle() {
  ...
  cp "$CALM_PREFERENCE" "$fixture/lib/fm-calm-preference.ts"
