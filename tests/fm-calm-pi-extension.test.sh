...
test_home_resolution() {
  ...
  cp "$PREFERENCE" "$fixture/project/.pi/extensions/lib/fm-calm-preference.ts"
  cp "$PERSISTENCE" "$fixture/project/.pi/extensions/lib/fm-calm-persistence.ts"
  ...
  cp "$VISIBILITY_CORE" "$fixture/project/.pi/extensions/lib/fm-calm-visibility-core.ts"
...
test_rendering_and_session_lifecycle() {
  ...
  cp "$PREFERENCE" "$fixture/lib/fm-calm-preference.ts"
  cp "$PERSISTENCE" "$fixture/lib/fm-calm-persistence.ts"
  cp "$OPERATIONAL_USER_LAYOUT" "$fixture/lib/fm-calm-operational-user-layout.ts"
  cp "$VISIBILITY" "$fixture/lib/fm-calm-visibility.ts"
  cp "$VISIBILITY_CORE" "$fixture/lib/fm-calm-visibility-core.ts"
...
test_operational_followup_turn_e2e() {
  ...
  cp "$PREFERENCE" "$project/.pi/extensions/lib/fm-calm-preference.ts"
  cp "$PERSISTENCE" "$project/.pi/extensions/lib/fm-calm-persistence.ts"
  ...
  cp "$VISIBILITY_CORE" "$project/.pi/extensions/lib/fm-calm-visibility-core.ts"
