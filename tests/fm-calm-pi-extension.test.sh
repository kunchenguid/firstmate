...
test_rendering_and_session_lifecycle() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-extension-env.ts" "$fixture/lib/fm-extension-env.ts"
  cp "$ROOT/.pi/extensions/lib/fm-followup-delivery.ts" "$fixture/lib/fm-followup-delivery.ts"
