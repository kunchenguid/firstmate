...
EOF
  ...
  # One combined fakebin: tmux + proj (spawn/send/teardown) and no-mistakes
...
phase_spawn() {
  ...
  # and never ran a project-style proj new.
  ...
  assert_no_grep 'proj new' "$LOG" "secondmate spawn ran a project-style proj new"
