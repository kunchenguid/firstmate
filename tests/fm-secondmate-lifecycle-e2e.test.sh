...
#   - each project is cloned under the new subhome with its origin preserved
#     and the parent project clone is never mutated
...
phase_seed() {
  ...
  pass "seed: registry scope+projects, charter copied, clones+origins"
}
