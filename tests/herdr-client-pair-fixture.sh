...
# JSON. Each fake appends its argv to the <dir>/stale.log or <dir>/current.log
# baked into it at creation time, so a copy of a fake installed elsewhere on
# PATH stays attributable to the pair it came from.
