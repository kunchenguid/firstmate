...
#
# bin/fm-lint.sh is the shared definition for local and project CI lint.
# It pins the tool version so the command, file set, config, and diagnostics
# cannot diverge across those environments.
set -u
