...
test_source_graph_boundaries_keep_every_owner() {
  ...
  [ "$production_context_tests" = 'fm-backend-herdr.test.sh|fm-context-measure-lib.test.sh|fm-daemon.test.sh|fm-helm-takeover.test.sh|fm-pending-reply.test.sh|fm-secondmate-sync.test.sh|' ] \
