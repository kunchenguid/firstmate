...
test_handle_wake_terminal_signal_clears_pause_tracking() {
  ...
  : > "$state/.waiting-since-$watcher_key"
  ...
  [ ! -e "$state/.waiting-resurfaced-$watcher_key" ] || fail "terminal signal retained the watcher wait re-surface throttle"
  [ ! -e "$state/.waiting-since-$watcher_key" ] || fail "terminal signal retained the watcher wait cadence anchor"
  FM_STATE_OVERRIDE="$state" handle_wake "stale: $win" "$state"
