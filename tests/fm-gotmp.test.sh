...
make_fake_root() {
  ...
  # fm-treehouse-return-lib.sh: teardown sources it for the committed-work guard
  # that runs before every pooled-worktree return.
  ln -s "$ROOT/bin/fm-treehouse-return-lib.sh" "$fake/bin/fm-treehouse-return-lib.sh"
