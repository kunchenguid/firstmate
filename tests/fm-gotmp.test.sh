...
SH
  ...
  # fm-tasks-axi-lib.sh: stub (teardown sources it). Report an incompatible
  # tasks-axi so the fused backlog close is skipped and the follow-up echo takes
  # the plain-message path; there is no tasks-axi and no backlog in this fixture.
