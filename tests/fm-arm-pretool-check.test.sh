...
matrix_case A18 allow "source '$ROOT/config/wa-mode.env'; bin/fm-watch-checkpoint.sh --seconds 180"
matrix_case A19 allow "[ -f '$ROOT/config/wa-mode.env' ] && . '$ROOT/config/wa-mode.env'; exec bin/fm-watch-arm.sh"
...
matrix_case E18 deny "source '/tmp/not-firstmate/config/wa-mode.env'; bin/fm-watch-checkpoint.sh --seconds 180"
