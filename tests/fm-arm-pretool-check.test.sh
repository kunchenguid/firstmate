...
matrix_case A18 allow 'source config/telegram-mode.env; bin/fm-watch-checkpoint.sh --seconds 180'
matrix_case A19 allow "source '$ROOT/config/x-mode.env'; source '$ROOT/config/telegram-mode.env'; exec bin/fm-watch-arm.sh"
...
matrix_case E18 deny "source '/tmp/not-firstmate/config/telegram-mode.env'; bin/fm-watch-checkpoint.sh --seconds 180"
