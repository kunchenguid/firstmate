...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-cursor-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    ...
    fm-muse-signals-live-e2e.test.sh|fm-cursor-signals-live-e2e.test.sh|\
    fm-cursor-herdr-live-e2e.test.sh|\
