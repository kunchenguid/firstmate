...
family_for_basename() {
  case "$1" in
    ...
    fm-bootstrap.test.sh|fm-bootstrap-network-parallel.test.sh|fm-dispatch-resolve.test.sh|fm-intake-classify.test.sh|fm-fleet-sync.test.sh|fm-gate-refuse.test.sh|fm-gotmp.test.sh|\
