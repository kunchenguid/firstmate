...
family_for_basename() {
  case "$1" in
    ...
    fm-blesh-launch-tmux-live-e2e.test.sh|fm-blesh-launch-herdr-live-e2e.test.sh|\
    ...
    fm-trace-context-spawn.test.sh|fm-spawn-worktree-settle.test.sh|fm-spawn-shell-accept.test.sh|\
