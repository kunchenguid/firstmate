...
family_for_basename() {
  case "$1" in
    ...
    fm-wake-queue.test.sh|fm-watch-arm.test.sh|fm-watch-checkpoint.test.sh|fm-watch-sandbox-bridge.test.sh|fm-watch-triage.test.sh|\
    ...
    fm-spawn-docker-transaction.test.sh|fm-trace-context-spawn.test.sh|fm-spawn-worktree-settle.test.sh|\
