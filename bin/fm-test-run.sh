...
family_for_basename() {
  case "$1" in
    ...
    fm-send-secondmate-marker.test.sh|fm-shared-captain-inheritance.test.sh)
      printf '%s\n' secondmate
      ;;
    fm-account-lane.test.sh|fm-bootstrap-dispatch-policy.test.sh|fm-bootstrap.test.sh|fm-dispatch-policy.test.sh|fm-fleet-sync.test.sh|fm-gate-refuse.test.sh|fm-gotmp.test.sh|\
    ...
    fm-quota-array-dispatch-live-e2e.test.sh|fm-automatic-dispatch-live-e2e.test.sh|fm-send-secondmate-marker-herdr-e2e.test.sh|\
