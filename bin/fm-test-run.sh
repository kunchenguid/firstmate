...
family_for_basename() {
  case "$1" in
    ...
    fm-documentation-audiences.test.sh|fm-ensure-agents-md.test.sh|fm-cursor-harness.test.sh|\
    fm-grok-harness.test.sh|fm-kimi-harness.test.sh|fm-herdr-lab.test.sh|fm-instruction-owners.test.sh|fm-lint.test.sh|\
