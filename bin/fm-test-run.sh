...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-cursor-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    ...
    fm-session-lock.test.sh|fm-session-start.test.sh|fm-sessionstart-nudge.test.sh|fm-tangle-guard.test.sh|\
    fm-update.test.sh)
      printf '%s\n' session-bootstrap
      ;;
