...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-rovo-harness.test.sh|fm-agy-harness.test.sh|fm-omp-harness.test.sh|fm-herdr-lab.test.sh|fm-host-setup.test.sh|fm-lint.test.sh|\
    ...
    fm-control.test.sh|fm-control-relaunch.test.sh|fm-host-root-mode.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-composer-lib.sh)
      ...
      printf '%s\n' live-harness-optin
      ;;
    bin/fm-spawn.sh|bin/fm-send.sh|bin/fm-harness.sh|bin/fm-control.sh|bin/fm-control-lib.sh|\
