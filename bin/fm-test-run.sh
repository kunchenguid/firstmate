...
# behavior test is tests/fm-watch-triage.test.sh at 263s, and the slowest script
# in a runner-file changed selection is tests/fm-calm-pi-extension.test.sh at 77s
# once its Chrome reap terminates. 900s leaves roughly 3.4x headroom over the
