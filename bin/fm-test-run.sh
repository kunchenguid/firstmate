...
family_for_basename() {
  case "$1" in
    ...
    fm-update.test.sh)
      printf '%s\n' session-bootstrap
      ;;
    fm-afk-pi-herdr-return-e2e.test.sh|fm-child-herdr-e2e.test.sh|\
    ...
    fm-child.test.sh|fm-herdr-session-cleanup.test.sh|fm-send-strict.test.sh|fm-spawn-batch.test.sh|\
