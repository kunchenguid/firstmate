...
family_for_basename() {
  case "$1" in
    ...
    fm-project-cockpit-render.test.sh|fm-project-cockpit.test.sh)
      printf '%s\n' snapshot-bearings
      ;;
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-home-summary-refresh.sh|bin/fm-project-cockpit-board.sh|\
    bin/fm-project-cockpit-snapshot.sh|assets/project-cockpit-template.html|\
    tests/fixtures/project-cockpit/*)
      printf '%s\n' snapshot-bearings
      ;;
