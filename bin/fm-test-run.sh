...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-devin-harness.test.sh|fm-polytoken-harness.test.sh|fm-muse-harness.test.sh|fm-rovo-harness.test.sh|fm-agy-harness.test.sh|fm-omp-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    ...
    fm-devin-signals-live-e2e.test.sh|fm-polytoken-signals-live-e2e.test.sh|fm-muse-signals-live-e2e.test.sh|fm-rovo-signals-live-e2e.test.sh|fm-agy-signals-live-e2e.test.sh|\
