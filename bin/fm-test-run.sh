...
tests/fm-afk-return.test.sh 17742
...
tests/fm-cursor-primary-live-e2e.test.sh 48
tests/fm-cursor-primary.test.sh 53264
tests/fm-daemon.test.sh 28341
tests/fm-documentation-audiences.test.sh 790
tests/fm-extension-binding.test.sh 9516
tests/fm-fleet-snapshot-view.test.sh 8465
tests/fm-fleet-sync.test.sh 39276
tests/fm-gate-refuse.test.sh 5314
...
tests/fm-guard-stale-banner.test.sh 11789
tests/fm-harness-adapter-instructions-live-e2e.test.sh 46
tests/fm-harness-adapter-references.test.sh 59
...
tests/fm-kimi-harness.test.sh 18869
...
tests/fm-muse-harness.test.sh 41787
tests/fm-muse-signals-live-e2e.test.sh 52
tests/fm-nm-test-contract.test.sh 904
tests/fm-no-mistakes-required.test.sh 227
tests/fm-omp-harness.test.sh 47424
...
tests/fm-pending-reply.test.sh 31064
...
tests/fm-quota-choose.test.sh 1516
tests/fm-remote-backlog-handoff.test.sh 46235
...
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 230898
...
tests/fm-secondmate-restart.test.sh 44367
...
tests/fm-send-inbox.test.sh 38702
tests/fm-send-remote-delivery.test.sh 30085
tests/fm-send-resolve-key.test.sh 29167
...
tests/fm-session-start.test.sh 166525
...
tests/fm-spawn-dispatch-profile.test.sh 120071
tests/fm-spawn-pool-base-freshen.test.sh 56127
...
tests/fm-tmux-agent-liveness.test.sh 2473
tests/fm-tool-update-check.test.sh 14082
tests/fm-trace-context-lib.test.sh 226
tests/fm-trace-context-spawn.test.sh 47816
tests/fm-turnend-guard.test.sh 24358
tests/fm-update.test.sh 10002
tests/fm-vendor-auth-probe.test.sh 46112
tests/fm-voice-relay.test.sh 33858
tests/fm-wake-daemon-lifecycle-e2e.test.sh 7614
