...
family_for_basename() {
  case "$1" in
    ...
    fm-operational-input.test.sh|fm-pi-lavish-poll-extension.test.sh|fm-pi-primary-types.test.sh|\
    ...
    fm-pi-lavish-poll-live-e2e.test.sh|fm-pi-primary-live-e2e.test.sh|\
