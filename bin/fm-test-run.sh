...
family_for_basename() {
  case "$1" in
    ...
    fm-pi-primary-types.test.sh|fm-project-pool.test.sh|fm-quota-alert.test.sh|fm-relay.test.sh|\
    ...
    fm-treehouse-lib.test.sh|fm-test-run.test.sh|fm-test-isolation-proof.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    ...
    fm-spawn-worktree-settle.test.sh|fm-tmux-fleet-isolation.test.sh)
      printf '%s\n' backend-dispatch
      ;;
