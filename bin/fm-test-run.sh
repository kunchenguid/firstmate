...
family_for_basename() {
  case "$1" in
    ...
    fm-worker-bridge.test.sh|fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-rovo-harness.test.sh|fm-omp-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    ...
    fm-worker-bridge-herdr-live-e2e.test.sh|fm-worker-bridge-live-e2e.test.sh|fm-muse-signals-live-e2e.test.sh|fm-rovo-signals-live-e2e.test.sh|\
