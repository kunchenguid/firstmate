...
#     The trailing colon also forces session-name interpretation on both tmux
#     calls, so a purely numeric session name (e.g. the default "0") is not
#     misparsed as a window-index target ("index 0 in use").
