...
#
# Worktree acquisition is outside this adapter: fm-spawn.sh durably acquires
# the Treehouse lease, sends the resulting top-level `cd`, and polls the pane's
# cwd through these send/current-path primitives.
#
...
#     the spawn-time cd enters the worktree, which would break name-based targeting.
