...
#
# Worktree acquisition (leasing or running `treehouse get`, then polling the
# pane cwd) is unchanged by this extraction: P1 scopes only the session
...
# (cd into a leased worktree or interactive `treehouse get`, the GOTMPDIR
