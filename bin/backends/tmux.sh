...
# (`treehouse get`, the PWD normalization, the GOTMPDIR export) that already ran
# this exact sequence inline in fm-spawn.sh. Mirrors `tmux send-keys -t "$T" "<text>" Enter`.
