...
# a crew waiting on the human wakes its supervisor sub-second instead of waiting
# for the stale-pane polling backstop. Everything not `blocked` is streamed too
