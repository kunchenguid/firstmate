...
# Alternation, not a bracket class: in a C/byte locale [❯›] is a byte set, and
# box-drawing glyphs (╭ ╰ │) share the leading 0xe2 byte, so a bracket class
# false-matches border rows. '^(❯|›)' requires the full multibyte sequence.
