...
# fm_backend_herdr_pane_idle_shell_pid below this makes no idle-shell claim and
...
#   3. The pane is PROVABLY absent - herdr answers `pane_not_found`, the same
...
# recovered. fm_backend_herdr_relaunch_placement above is the ONLY path out of
