...
# native agent-state, its Pi exception uses the identity-corroborated
# structural composer verdict, and its non-idle baseline falls back to the
# rendered busy-footer transition described above.
