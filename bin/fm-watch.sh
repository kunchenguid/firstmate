...
# cursor: "ctrl+c to stop" (the right-aligned mid-turn hint on Cursor Agent's
# follow-up line, shown iff a turn is running; at idle that slot reads
# "Run Everything" instead - verified cursor-agent 2026.07.17-3e2a980).
