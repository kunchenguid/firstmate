...
# spinner signature is likewise matched only for a recorded Kimi task. Cursor's
# end-anchored "ctrl+c to stop" footer and older "Running  <N> tokens" line are
# matched only for a recorded Cursor task (see fm_busy_lines_match).
