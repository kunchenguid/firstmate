...
# locale fragility of matching grok's braille spinner glyph directly); copilot:
# "esc cancel" (copilot's mid-turn footer hint, e.g. "Working esc cancel", absent
# when idle - verified GitHub Copilot CLI 1.0.68).
