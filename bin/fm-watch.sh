...
# locale fragility of matching grok's braille spinner glyph directly); Kimi:
# "thinking...", "working...", and "Running a command" (verified Kimi 0.29.0).
BUSY_REGEX=${FM_BUSY_REGEX:-'esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|thinking\.\.\.|working\.\.\.|Running a command'}
