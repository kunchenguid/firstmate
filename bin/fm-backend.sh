...
#   - the session-provider CLI itself (tmux/herdr/zellij/orca/cmux/thurbox-cli);
...
# agent-process recovery path has not been empirically validated, and thurbox
# because its panes' process attribution has had no empirical pass on thurbox's
# own tmux socket (docs/thurbox-backend.md "Active limits"). Orca and cmux do
# not support secondmate spawns.
