...
# (tmux) path stays byte-identical. P2 adds bin/backends/herdr.sh, a supported
...
# spawn-capable backend, currently supported herdr or experimental zellij,
# orca, or cmux,
...
# section 4's harness-verification discipline. herdr is supported and has its
# own required CI lane; docs/herdr-backend.md owns current coverage and limits.
# zellij is EXPERIMENTAL (P3;
