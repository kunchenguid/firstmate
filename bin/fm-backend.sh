...
# exact window. The Herdr adapter reuses its husk classifier. Zellij authorizes
# recovery only when a readable inventory proves the recorded session or task
