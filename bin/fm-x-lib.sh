...
#                                (delegates to bin/fm-env-lib.sh's fm_env_get)
...
# Relay's name for the shared `.env` reader. bin/fm-env-lib.sh owns what a
# KEY=VALUE line means; this delegates rather than carrying a second parser.
