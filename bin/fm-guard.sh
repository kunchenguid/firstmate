...
# source or result, or an X-mode relay poll needs supervision.
fm_supervision_status "$STATE" "$GRACE"
in_flight=$FM_SUP_IN_FLIGHT
sources=$FM_SUP_SOURCES
results=$FM_SUP_RESULTS
  ...
  if [ "$print_full_banner" -eq 1 ]; then
    ...
    rule='━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
    {
      ...
      if [ "$in_flight" -gt 0 ]; then
        ...
        printf '●  %s unhandled process-event result(s) waiting, but %s.\n' "$results" "$watcher_cause"
      else
