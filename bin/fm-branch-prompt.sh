...
A PR URL you pass to a tool or write into a summary is copied verbatim from the task's `done: published; PR <url>` or `done: green-CI; PR <url> checks green` status line, a legacy `done: PR <url> ...` line, or its `pr=` metadata field.
