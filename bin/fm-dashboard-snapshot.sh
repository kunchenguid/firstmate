...
DASHBOARD_SECONDMATE_LIMIT=${FM_DASHBOARD_SECONDMATE_LIMIT:-6}
DASHBOARD_SECONDMATE_TIMEOUT=${FM_DASHBOARD_SECONDMATE_TIMEOUT:-1}
DASHBOARD_PARENT_ACTIVITY_TIMEOUT=${FM_DASHBOARD_PARENT_ACTIVITY_TIMEOUT:-1}
DASHBOARD_TERMINAL_TIMEOUT=${FM_DASHBOARD_TERMINAL_TIMEOUT:-1}
DASHBOARD_REGISTRY_TIMEOUT=${FM_DASHBOARD_REGISTRY_TIMEOUT:-1}
...
Dashboard enrichment is bounded to six secondmate homes with three one-second reads each, one registry read, and three PR repositories at five seconds each by default.
EOF
}
...
fleet=$(FM_HOME="$FM_HOME" \
  ...
  FM_SNAPSHOT_PARENT_ACTIVITY_TIMEOUT="$DASHBOARD_PARENT_ACTIVITY_TIMEOUT" \
  FM_SNAPSHOT_TERMINAL_TIMEOUT="$DASHBOARD_TERMINAL_TIMEOUT" \
  FM_SNAPSHOT_REGISTRY_TIMEOUT="$DASHBOARD_REGISTRY_TIMEOUT" \
