...
# work, an X-mode relay poll, a validated registered custom check, or a
# registered process-to-event source, and whether its watcher has a fresh
...
#   FM_SUP_CHECKS         count of validated registered custom checks
...
#                         validated custom check, or a registered event source
