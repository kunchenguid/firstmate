...
content_in_default() {
  ...
  fm_pr_content_in_ref "$WT" "$ref" HEAD
}
...
# A refused, skipped, or failed Herdr close must never erase durable task
# identity; see require_herdr_endpoint_confirmed_gone in bin/fm-cleanup-lib.sh.
