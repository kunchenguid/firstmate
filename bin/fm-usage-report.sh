...
#
# Output is aligned plain text; per-task unavailable token fields render as
# "-". Model totals exclude source=unavailable rows and sum null fields as
# zero. These are usage totals, not monetary costs.
