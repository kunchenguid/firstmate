...
# token (bin/fm-x-lib.sh and its callers) and the optional OpenRouter dispatch
# key (bin/fm-jev.sh and bin/fm-dispatch-resolve.sh) both resolve their value through
