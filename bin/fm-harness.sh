...
# Usage: fm-harness.sh                  print own harness: claude|codex|opencode|pi|pi-signed|grok|kimi|cmd|unknown
...
detect_own() {
  ...
  for _ in 1 2 3 4 5 6 7 8; do
    ...
    case "$(basename "$comm")" in
      *claude*|agy|*agy*) echo claude; return ;;
