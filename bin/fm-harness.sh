...
# whitespace-separated. A bare "<harness>" selects only the harness, so the model
# and effort subcommands return empty; fm-spawn owns adapter-specific launch defaults.
