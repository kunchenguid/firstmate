...
#     "statusEndpoint":N,"statusIdent":"..."}. `silent` true is legal only on
#     verdict routine (a no-change heartbeat or a no-new-fact follow-up).
#     Legacy rows without `silent` or status provenance remain valid and are
#     treated as visible.
