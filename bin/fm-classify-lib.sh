...
# status log under a matching identity. Absent or empty index is uncovered
# (return 1); an invalid index is also uncovered. Used by watcher absorb
# proofs that must fail open to surfacing.
