...
# shared authoritative proof for no-verb signals. fm-watch.sh may additionally
# absorb a bare turn-end on pane churn, while every other failed verdict surfaces
