...
# is also healthy while the beacon is fresh and a live Pi session provably owns
# continuity through fm_pi_extension_owns_supervision. A lock with any recorded
