...
# Treehouse pool-slot identity and the slot-owner claim live in their own pure
# library, so a detect-only caller can read a claim without this file's
# source-time state-directory creation.
