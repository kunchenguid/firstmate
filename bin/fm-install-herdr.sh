...
#
# Pins Herdr v0.8.0 (protocol 19), the suite-verified presentation release.
...
# at or above the required floor (19 for the real-Herdr family).
set -eu
...
# Bounded download ceiling (bytes). The largest official 0.8.0 asset is under 20 MiB.
