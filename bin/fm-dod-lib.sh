...
# absolute path to bin/fm-nm-watch.sh. bin/fm-brief.sh and bin/fm-promote.sh
# both already set FM_ROOT before calling fm_dod_block; this default keeps the
# library self-sufficient under `set -u` for anything else that sources it
# directly, such as a test.
