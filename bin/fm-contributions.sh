...
# the budget runs out mid-observation or a per-call timer expires, the poll
# ends silently with that URL's records untouched. A genuine forge failure or
