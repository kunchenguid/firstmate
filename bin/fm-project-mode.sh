...
# bin/fm-home-seed.sh (run no-mistakes init for a newly cloned project),
# bin/fm-remote-home-seed.sh (refuse a local-only project on a remote route,
# whose host can neither clone the folder nor receive a landing into it), and
