...
#   - <name> [<mode>] - <desc>          -> <mode> off
#   - <name> [<mode> +yolo] - <desc>    -> <mode> on
#
# mode = how a finished change reaches main:
#   direct-PR    push + PR via gh-axi -> captain merge
...
# to stderr, so a typo never silently changes a project to local-only.
