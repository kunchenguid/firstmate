...
# The consumers are bin/fm-fleet-sync.sh (supply affirmative non-local evidence
# before remote-gone branch pruning), bin/fm-home-seed.sh and bin/fm-remote-home-seed.sh
