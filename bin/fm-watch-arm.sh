...
# owns this home, that daemon owns triage and the watcher exits on every wake for
# the daemon to classify. Reliability depends on arming through a mechanism that SURVIVES the
