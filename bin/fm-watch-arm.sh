...
# macOS and Git Bash/MSYS share a longer default so pre-lock migration plus the
# first beat can finish under ordinary scheduler delay; see
# fm_arm_confirm_timeout_seconds. An explicit FM_ARM_CONFIRM_TIMEOUT still wins.
CONFIRM_TIMEOUT=$(fm_arm_confirm_timeout_seconds)
