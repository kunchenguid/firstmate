...
# Codex ship and scout launches also pre-register their fresh worktree through
# bin/fm-codex-trust.sh. Codex secondmates retain their persistent home's one-time
# trust decision, matching the fork's existing contract.
