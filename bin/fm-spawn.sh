...
#        fm-spawn.sh <task-id> --relaunch [--harness <name>] [--model <name>] [--effort <level>] [--accept-claude-trust]
...
#   model, and effort may change, while --accept-claude-trust may add the
#   task-scoped grant for a Claude relaunch. That is what makes a harness switch
