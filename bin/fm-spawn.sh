...
#   oldest hold for the same pool when a worktree returns to it. Auto-detected
#   herdr stays silent like tmux; auto-detected cmux prints a loud stderr
#   notice; zellij and orca are never auto-detected.
