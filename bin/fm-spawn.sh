...
#     __CODEXMCPFLAG__ codex crewmate/scout launch-time MCP override; empty only
#                  when local config/crew-codex-mcp explicitly keeps MCP enabled
...
CODEXMCPFLAG=$(codex_mcp_flag_for_launch)
LAUNCH=${LAUNCH//__PROVIDERFLAG__/$PROVIDERFLAG}
LAUNCH=${LAUNCH//__MODELFLAG__/$MODELFLAG}
LAUNCH=${LAUNCH//__EFFORTFLAG__/$EFFORTFLAG}
LAUNCH=${LAUNCH//__CODEXMCPFLAG__/$CODEXMCPFLAG}
