...
#   from the project's local default-branch ref for local-only ships; other
#   spawns fetch origin, resolve the current remote default branch, and reset to
#   its tip. An unreachable origin, unresolved default branch, or non-clean
