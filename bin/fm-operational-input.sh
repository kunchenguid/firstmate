...
FM_OPERATIONAL_KINDS='session-start post-compact watcher turn-end-guard away-supervisor launch-brief branch-outcome'
...
Current construction kinds:
  session-start post-compact watcher turn-end-guard away-supervisor from-firstmate launch-brief
  branch-outcome
