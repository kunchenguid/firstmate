...
# happen to collide can send/peek/close each other's tabs - a gap review
# caught for cmux (docs/cmux-backend.md) and this same tag mechanism was later ported to
