...
# mode) for its read-only detect lines - missing tools, gh auth, Codex
# skill-budget reporting, the worktree-tangle check, the harness override,
# crew-dispatch validation, tasks-axi and quota-axi tool checks, and
# tasks-axi availability - none of
