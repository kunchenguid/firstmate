...
#                       projection cleanup and bootstrap's six MUTATING sweeps
...
#                       session holds the lock; the four network sweeps run in
#                       the deferred stage instead. The liveness sweep accounts
