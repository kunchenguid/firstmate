...
#                       mutating step runs.
#   2. bootstrap      - detect-only diagnostics always run. The MUTATING
#                       sweeps (legacy PR-check migration, relay reconnect, helm
#                       task adoption, secondmate fast-forward, secondmate
...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  %s\n' "$LOCK_OUT"
    printf '●  Skipping every mutating step: PR-check migration, relay reconnect, helm\n'
    printf '●  task adoption, secondmate sync, X-mode artifacts, fleet sync, and the\n'
