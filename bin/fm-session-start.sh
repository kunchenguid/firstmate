...
#                       fast-forward, secondmate liveness, X-mode and portal
#                       connector artifact writes, fleet sync) run only
...
# secondmate homes, writing X-mode or portal artifacts, fetching/fast-forwarding every
...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  X-mode and portal connector artifacts, fleet sync, and wake-queue drain.\n'
...
PORTAL_MODE_PRESENT=0
[ -f "$CONFIG/portal-mode.env" ] && PORTAL_MODE_PRESENT=1
...
"$SCRIPT_DIR/fm-supervision-instructions.sh" \
  ...
  --portal-mode "$PORTAL_MODE_PRESENT"
...
EOF
elif [ -f "$CONFIG/x-mode.env" ] || [ -f "$CONFIG/portal-mode.env" ]; then
  cat <<EOF
Follow the supervision operating instructions block above for harness '$PRIMARY_HARNESS'.
A messaging connector is active, so the emitted block's cadence instruction applies.
