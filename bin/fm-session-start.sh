...
#                       (legacy PR-check migration, relay reconnect, helm task
#                       adoption, secondmate convergence, secondmate liveness,
#                       pending remote handoff retry, X-mode artifact writes,
#                       fleet sync) also run only when locked; the network
...
# check, the harness override, crew-dispatch and harness-overrides validation,
# tasks-axi and quota-axi tool checks, and tasks-axi availability - none of which
# mutate shared state and all of which are safe to compute without verified lock
# ownership.
...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  relay reconnect, helm task adoption, secondmate convergence, secondmate\n'
    printf '●  liveness, pending remote handoff retry, X-mode artifacts, fleet sync, and the\n'
