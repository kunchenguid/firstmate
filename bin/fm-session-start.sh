...
# secondmate homes, retrying pending handoff outboxes, and fetching or
# fast-forwarding every project clone - before ever discovering
...
#             pending remote handoff retry) - and re-emit the rest.
