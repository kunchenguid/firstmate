...
#                       (legacy PR-check migration, recorded-worktree durable
#                       guarding, secondmate convergence, secondmate liveness,
...
#             recorded-worktree durable guarding, pending remote handoff retry,
