...
#
# Owner of the numeric-harness ancestry and liveness predicates used by
# bin/fm-claude-stop-autoarm.sh to prove that a Stop hook fires inside the
# lock-owning primary session before it may arm or rewake.
# bin/fm-lock.sh owns the broader typed lock and reclaim contract, including
# Codex thread identities and ambiguous process evidence.
