...
# lock-owning primary session before it may arm or rewake; and
# bin/fm-telegram-lib.sh uses it to let only a turn-end guard descending from
# that same lock owner advance the private Telegram handling epoch.
