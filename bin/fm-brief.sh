...
- \`## Problem\` - what was wrong or why this change, as tight bullets.
- \`## Fix\` - what the change does, as tight bullets.
- \`## Proof\` - evidence it works (tests added or passing, reproduction, screenshots or links), as tight bullets.
- Any other section (what changed, testing) stays a few bullets, not prose.
