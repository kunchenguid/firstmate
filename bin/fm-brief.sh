...
3. Use gh-axi for GitHub operations. Before any browser command, read and follow the tracked \`playwright-cli\` skill; use \`playwright-cli\` for ad hoc browser work, while project-owned automated end-to-end suites keep their existing test runner.
