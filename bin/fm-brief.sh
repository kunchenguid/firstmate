...
# Usage: fm-brief.sh <task-id> <repo-name> --mode <no-mistakes|direct-PR|local-only> [--herdr-lab] [--spec-forging]
#        fm-brief.sh <task-id> <repo-name> --scout [--herdr-lab] [--spec-forging]
