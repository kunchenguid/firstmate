...
'   Valid initial state is either explicit absence or exactly one running session named `default`; appearance, disappearance, stopping, change, or ambiguity is a hard tripwire failure.' \
'' \
