...
# Usage: fm-brief.sh <task-id> <repo-name> --mode <no-mistakes|direct-PR|local-only> [--herdr-lab] [--host-home <path> --host-root <path>] [--gui-host]
#        fm-brief.sh <task-id> <repo-name> --scout [--herdr-lab] [--host-home <path> --host-root <path>] [--gui-host]
...
INBOX_DIR=$(shell_quote "$BRIEF_STATE/$ID.inbox")
...
If your deliverable is a visual artifact the captain will review and iterate on, you may host the Lavish review loop yourself (poll, revise, re-serve, staying alive) instead of handing it back to firstmate.
  Before reporting done, read and follow \`$BRIEF_ROOT/.agents/skills/captain-hold-lifecycle/SKILL.md\` and pass its shared completion gate for the report and any visual review.
...
Before preparing or revising the PR/MR description, read and follow \`$BRIEF_ROOT/.agents/skills/pr-description/SKILL.md\`.
...
Before preparing or revising any later PR/MR description for this work, read and follow \`$BRIEF_ROOT/.agents/skills/pr-description/SKILL.md\`.
