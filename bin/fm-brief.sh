...
At every turn boundary, check this inbox before choosing or dispatching new work, refilling capacity, or handling a routine supervision wake. A waiting parent instruction takes priority after any currently running guarded command returns; do not let repeated local wake/refill cycles starve it.
