...
# placeholder and sibling "Resource: {RESOURCE}" RAM/disk-envelope and
# "Surface: {SURFACE}" dashboard-wiring placeholders Firstmate fills at intake
...
# line whenever the Proof bar section is present and the project is not
...
# loaded. Firstmate fills the {PREP}, {RESOURCE}, and {SURFACE} placeholders at
...
# suite, and to a missing or unfilled "Surface:" line whenever the Proof bar
