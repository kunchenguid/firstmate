...
This task runs through claim-before-allocation: no workspace or endpoint exists before the authoritative Decision OS claim receipt is observed (attempt <attempt_id>).
