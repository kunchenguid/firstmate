...
# config/pi-delegated-profile applies the same controlled Pi worker profile).
# It also pushes
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend herdr-presentation-spaces pi-delegated-profile}"
