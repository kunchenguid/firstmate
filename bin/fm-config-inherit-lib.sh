...
# hand-edit backlog files too, and primary config/scm-host=forgejo keeps GitHub
# prerequisites disabled fleet-wide). It also pushes the one primary-authoritative
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend scm-host}"
