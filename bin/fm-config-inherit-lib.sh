...
# hand-edit backlog files too, and primary config/backend=herdr keeps that home's
# task sessions on herdr too). It also pushes the one primary-authoritative
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend backend}"
