...
# profile rules, primary config/crew-skills.json makes its crewmates use the same
# plan/review phase skills, primary config/crew-harness=codex makes a secondmate's crewmates
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-skills.json crew-harness backlog-backend backend herdr-presentation-spaces startup-memory-budget trace-context}"
