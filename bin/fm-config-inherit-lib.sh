...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend backend herdr-presentation-spaces herdr-task-titles startup-memory-budget trace-context launch-env-allowlist claude-permission-mode lavish-axi-host}"
