...
async function installPackage(home, sourceInfo) {
  ...
  try {
    ...
    // Darwin refuses to rename a directory whose owner-write bit is absent.
    // The lifecycle lock still serializes competing publishers; restore the
    // exact installed mode immediately after the content-addressed rename.
