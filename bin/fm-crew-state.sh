...
# CREW_BRANCH is empty at detached HEAD (a just-spawned writer or writer scout)
# and in checkout-free reader scratch; with no branch there is no run to attribute to this crew.
