...
# cmux, and paseo are real backends elsewhere in firstmate (bin/fm-backend.sh)
# but this daemon is not wired up for them yet - see
...
fm_super_main() {
  ...
  # tmux/herdr-specific call against it (zellij, orca, cmux, and paseo are not
  # wired up for this daemon yet - AGENTS.md section 4
