...
# docs/herdr-backend.md and primary-runtime's harness-verification trigger. Selecting one refuses loudly at startup
...
fm_super_main() {
  ...
  # composer/busy primitives wired up for this daemon yet - primary-runtime's
  # harness-verification trigger). This is the clear refusal the task calls
