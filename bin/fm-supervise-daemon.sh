...
#          Long-lived background loop. Normally started by the /afk helper,
#          which verifies an injectable supervisor target before setting
#          state/.afk and execing this daemon. Env knobs:
