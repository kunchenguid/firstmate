...
fm_super_main() {
  ...
  # composer/busy primitives wired up for this daemon yet - the harness-adapters
  # skill's harness-verification discipline). This is the clear refusal the task calls
