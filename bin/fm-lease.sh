...
#       this after each settled branch turn and at generation activation, and
#       the supervision host runs it after each engine turn, so abandoned or
#       replaced branch conversations cannot strand leases.
#   fm-lease.sh sweep
