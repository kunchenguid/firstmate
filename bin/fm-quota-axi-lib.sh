...
#                                  back to the codex-home account row and stops
#                                  there, never reaching "default"; every other
#                                  unmatched lane falls back to "default". An
#                                  exact accountKey row always wins over the
#                                  fallback.
