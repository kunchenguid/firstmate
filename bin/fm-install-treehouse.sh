...
#
# Pins Treehouse v2.3.0 for lease JSON and conditional lease-id return support.
set -eu
...
# Archive layout: a single `treehouse` binary at the archive root (the supported release layout).
