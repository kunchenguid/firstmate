...
# cursor: "ctrl+c to stop" (cursor's mid-turn hint; at idle that slot instead
# reads "Run Everything" - verified cursor-agent 2026.07.17-3e2a980, matched in
# ASCII to avoid the locale fragility of its braille spinner).
