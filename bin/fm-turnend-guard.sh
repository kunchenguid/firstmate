...
REASON=$("$SCRIPT_DIR/fm-supervision-instructions.sh" --afk "$afk" --x-mode "$x_mode" --portal-mode "$portal_mode" --repair-line 2>/dev/null \
...
rule='━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
{
  ...
  if [ "$FM_SUP_IN_FLIGHT" -gt 0 ]; then
    ...
    printf '●  Messaging is active, but no live watcher holds this home lock (last beat: %s).\n' "$FM_SUP_BEACON_DESC"
  fi
  printf '●  %s\n' "$REASON"
  printf '●%s\n' "$rule"
} >&2
