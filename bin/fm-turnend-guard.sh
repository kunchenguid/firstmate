...
block_stop() {
  ...
  rule='━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    if [ "$FM_SUP_IN_FLIGHT" -gt 0 ]; then
      ...
      printf '●  An armed inbound message channel needs supervision, but no live watcher holds this home lock (last beat: %s).\n' "$FM_SUP_BEACON_DESC"
    fi
...
if [ "$terminal_status" -eq 0 ]; then
  if [ "$FM_SUP_IN_FLIGHT" -gt 0 ]; then
    ...
    NEED_DESC="an armed inbound message channel"
  fi
