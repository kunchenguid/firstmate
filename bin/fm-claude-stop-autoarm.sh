...
#   - Need: arms while work is in flight, a registered custom check or
#     process-event source needs polling, or X mode has a relay poll to run.
#     A home with none of those needs exits 0.
...
# --- need: any shared supervision predicate ----------------------------------
need_supervision() {
