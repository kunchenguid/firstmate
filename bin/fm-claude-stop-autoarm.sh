...
#   - Need: arms only while work is in flight or process-event sources are
#     registered; an idle home exits 0.
...
# --- need: in-flight work or registered process-event source -----------------
need_supervision() {
