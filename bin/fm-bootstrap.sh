...
#          lavish-axi). tasks-axi is also feature gated (update --archive-body
#          and mv [<id>...], the latter putting the effective floor at 0.2.2+;
#          docs/configuration.md owns the definition); an installed but incompatible build
