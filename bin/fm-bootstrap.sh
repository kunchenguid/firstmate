...
#          1.46.0, the release that started writing the structured pipeline step
#          attestation that the repo's own "Require no-mistakes" check parses out
#          of the PR body; an older gate pushes a PR that check then rejects.
