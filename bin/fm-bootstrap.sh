...
crew_dispatch_validate() {
  ...
  err=$(jq -r '
    def verified($h): ["claude","codex","opencode","pi","pi-signed","grok","kimi","cursor","agy","muse","rovo","omp","humanlayer"] | index($h);
    def effort_ok($h; $m; $e):
      if $e == null then true
      ...
      elif $h == "humanlayer" then (["low","medium","high","xhigh"] | index($e))
