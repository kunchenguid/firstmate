...
#          secondmate_handoff_resume, x_mode_setup, ops_inbox_setup, fleet_sync) while still
...
#          X-mode artifacts, the operational alert watch, project clones, or
#          repair instructions.
