...
secondmate_sync() {
  ...
  secondmate_sync_remote_one() {  # <id> <home> <remote-host>
    ...
    local sync_out inherit_out inherit_status nudge_needed remote_marker remote_pending converged out remote_lock remote_generation
