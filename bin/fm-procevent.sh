...
# never doubled, and a source whose registration is gone has no record left to
# acknowledge into. It runs before this cycle publishes anything or starts any
